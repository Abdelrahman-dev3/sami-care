                    ...
                    <div class="col-md-3">
                        <div class="datatable-filter">
                            <select name="payment_method" id="payment_method" class="select2 form-control" data-filter="select">
                                <option value="">{{ __('report.lbl_payment_method') }}</option>
...
<script type="text/javascript" defer>
    ...
    const columns = [
        ...
        },
        {
            data: 'transaction_id',
            name: 'transaction_id',
            title: "{{ __('report.lbl_transaction_id') }}",
            orderable: false,
            searchable: false,
        },
        {
            data: 'payment_method',
            name: 'payment_method',
            title: "{{ __('report.lbl_payment_method') }}",
            orderable: false,
            searchable: false,
        },
        {
        ...
        },
        {
            data: 'total_amount',
            name: 'total_amount',
            title: "{{ __('report.lbl_total_amount') }}",
            orderable: false,
            searchable: false,
        },
    ]
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        initDatatable({
            url: "{{ route('backend.reports.payment-transactions-report.index_data') }}",
            finalColumns,
            advanceFilter: () => {
                return {
