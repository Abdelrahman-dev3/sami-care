...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('pages-css/profile.css') }}">
</head>
<body>
    ...
    <div class="container my-5">
        <div class="profile-card p-4">
            ...
            <div class="col-md-1 H-editProfileModal">
                ...
                @csrf
                    <button type="submit" class="btn logout-btn" style="border-radius: 30px;" title="{{__('profile.logout')}}"><i class="fa-solid fa-right-from-bracket"></i>  {{ __('messages.logout') }} </button>
                </form>
            </div>
        </div>
        </div>
    ...
    <div class="stats-box">
        ...
        <div class="stat-item">
            <a href="{{route('profile.complateGift')}}">
              <h6> <span class="stat-icon"><img src="{{ asset('images/icons/true.png') }}"></span>{{ __('messages.gift_cards_list') }}</h6>
              <div><span class="stat-value">{{$completedGift}}</span> <span class="stat-unit">{{ __('profile.gift') }}</span></div>
            </a>
        </div>
  </div>
    ...
    <div class="col-lg-4">
      <div class="payment-box shadow-sm">
        ...
        <div class="row g-3 text-center">
          <div class="col-6">
            <img src="{{asset('images/icons/visa.png')}}" alt="Visa" class="img-fluid  rounded p-3" style="background: #F8F8F8;">
          </div>
          <div class="col-6">
            <img src="{{asset('images/icons/mada.png')}}" alt="Mada" class="img-fluid  rounded p-3" style="background: #F8F8F8;">
          </div>
          <div class="col-6">
            <img src="{{asset('images/icons/tamara.png')}}" alt="تمارا" class="img-fluid border rounded p-3" style="background: #F8F8F8;">
          </div>
          <div class="col-6">
            <img src="{{asset('images/icons/tabby.png')}}" alt="tabby" class="img-fluid  rounded p-3" style="background: #F8F8F8;">
          </div>
        </div>
      </div>
    </div>
        ...
        @forelse($bookings as $booking)
            @foreach($booking->services as $service)
                <div class="table-content">
                    <h5 title="{{$service->service_name ?? '---'}}">{{ \Illuminate\Support\Str::limit($service->service_name ?? '---', 14) }}</h5>
