...
<section class="position-relative my-5" style="height:455px">
    <img src="{{ asset('images/pages/gift-bg.png') }}" alt="{{ __('messagess.background_alt') }}" class="w-100 h-100 position-absolute top-0 start-0" style="object-fit: cover; min-height: fit-content">
    ...
    <div class="position-relative d-flex flex-column align-items-center justify-content-center text-center px-2 px-md-0"style="font-weight: bold;min-height: 400px;z-index: 3;gap: 38px;">
        ...
        <img src="{{ asset('images/icons/Vector.png') }}" alt="{{ __('messagess.card_alt') }}" class="gift-card-img-responsive" style="width: 60px;object-fit: cover;">
        ...
        <div>
            <a href="{{ route('gift.page') }}" class="btn b_h text-white d-flex align-items-center justify-content-center gap-2 mx-auto px-3 px-md-5 py-3 fs-5 fs-md-5 gift-btn-responsive"
               style="z-index: 9;position: relative;border-radius: 30px;background: linear-gradient(45deg, #CF9233, #694A1A);width: 349.775px;height: 54px;">
                <span class="text-center" style="font-size: 22.4px;white-space: nowrap;">{{ __('gift.choose_gift_now') }}</span>
