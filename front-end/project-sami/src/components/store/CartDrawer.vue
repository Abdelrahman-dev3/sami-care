...
:global(html[dir="rtl"] .global-cart){inset:0 auto 0 0;box-shadow:30px 0 80px rgba(0,0,0,.28);transform:translate3d(-104%,0,0)}
:global(html[dir="rtl"] .global-cart.on){transform:translate3d(0,0,0)}
:global(html[dir="ltr"] .global-cart){inset:0 0 0 auto;box-shadow:-30px 0 80px rgba(0,0,0,.28);transform:translate3d(104%,0,0)}
:global(html[dir="ltr"] .global-cart.on){transform:translate3d(0,0,0)}
