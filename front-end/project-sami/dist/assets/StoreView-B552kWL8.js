import{_ as re,i as P,X as S,o as t,c as s,b as e,n as j,t as i,q as V,d,a as g,u as r,Y as D,x as K,z as W,Z as k,E as U,F as $,e as Y,V as m,p as Q,I as X,$ as oe,r as T,A as te,Q as G,m as ae,w as ie,h as se,P as le,C as J,a0 as de,a1 as pe,S as ge}from"./index-BWc_r5XW.js";import{u as ce}from"./usePageStyles-CFfKXM_a.js";import{u as xe}from"./useInternalLinks-B6-MGd4J.js";import{P as be}from"./ProductStock-DFDtsuw4.js";const fe=`
:root{
...
.loc-item{display:grid;grid-template-columns:1fr 104px;align-items:center;gap:11px;
  border:1.5px solid #efe9e0;border-radius:16px;padding:9px;background:#fff;cursor:pointer;text-align:start;width:100%}
...
.st-hero{position:relative;overflow:hidden;margin-top:22px;min-height:360px;
...
.st-hero .in{position:relative;z-index:3;padding:30px max(40px,calc((100vw - 1280px)/2 + 40px))}
...
.st-hero h1{font-family:var(--font-d);font-size:clamp(30px,3.4vw,44px);color:var(--ivory);line-height:1.2;margin:12px 0 10px}
...
.st-hero .hero-ctas{display:flex;gap:12px;margin-top:18px;flex-wrap:wrap}
...
.st-hero .hero-stats{display:flex;gap:0;margin-top:18px;border-top:1px solid var(--line-dark);padding-top:14px}
...
/* مشهد المنتجات */
.hero-scene{position:relative;height:100%;min-height:360px;z-index:2;perspective:900px}
...
.pcard .pimg .prod-photo{width:100%;height:100%;object-fit:cover;display:block;transition:transform .5s var(--ease)}
.pcard:hover .pimg .prod-photo{transform:scale(1.07)}
...
.pcard .pimg .shelf{position:absolute;bottom:0;inset-inline:0;height:26%;
  background:linear-gradient(180deg,rgba(233,207,142,.1),rgba(20,16,9,.6));}
...
.pgrid.list .pbody{text-align:start;padding:16px 20px}
...
`,me="/mobile/assets/products/beard-oil.webp",he="/mobile/assets/products/featured-moisturizer.webp",ve="/mobile/assets/products/face-serum.webp",ee=[{id:"sp1",badge:"عرض محدود",title:"اشترِ 2 واحصل على الثالث مجانًا",text:"على مجموعة مختارة من منتجات العناية بالشعر واللحية",cta:"تسوق العرض"}],ue=[{id:"mada",n:"مدى",d:"ادفع باستخدام بطاقات مدى",logo:"مدى mada",form:!0},{id:"apple",n:"Apple Pay",d:"دفع سريع وآمن عبر أجهزتك",logo:" Pay",form:!1},{id:"card",n:"فيزا / ماستركارد",d:"بطاقات ائتمانية أو مسبقة الدفع",logo:"VISA ●●",form:!0},{id:"urpay",n:"يورباي",d:"الدفع باستخدام محفظة يورباي",logo:"UrPay",form:!1},{id:"wallet",n:"المحفظة",d:"ادفع من رصيدك في سامي",logo:"👛",form:!1},{id:"cod",n:"الدفع عند الاستلام",d:"ادفع عند استلام طلبك",logo:"💵",form:!1}],ke={class:"pimg"},ye=["data-fav"],we=["src","alt"],ze=["width","height","viewBox","innerHTML"],Fe={class:"pbody"},$e={class:"prow"},Ce=["data-add"],_e=["aria-label"],Be=["aria-label"],Ee={key:0,width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},Me={key:1,width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.4"},Ae={class:"qstep__val"},je={class:"pr"},Se={__name:"ProductCard",props:{p:{type:Object,required:!0},index:{type:Number,default:0},view:{type:String,default:"grid"},fav:{type:Boolean,default:!1},qty:{type:Number,default:0}},emits:["toggle-fav","add","set-qty"],setup(c){const E=c,h=P(()=>`animation-delay:${Math.min(E.index*.05,.4)}s`),C=P(()=>E.view==="list"?96:118),F=P(()=>S(E.p.shape,C.value));return(v,p)=>(t(),s("article",{class:"pcard",style:K(h.value)},[e("div",ke,[p[5]||(p[5]=e("div",{class:"shelf"},null,-1)),c.p.badge?(t(),s("span",{key:0,class:j(["badge-tag",{new:c.p.new}])},i(c.p.badge),3)):V("",!0),e("button",{class:j(["fav2",{on:c.fav}]),"data-fav":c.p.id,"aria-label":"مفضلة",onClick:p[0]||(p[0]=x=>v.$emit("toggle-fav",c.p.id))},[...p[4]||(p[4]=[e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8"},[e("path",{d:"M12 21s-7-4.4-9.3-8.5C.8 9 2.6 5.5 6 5.5c2 0 3.4 1.1 4 2.3.6-1.2 2-2.3 4-2.3 3.4 0 5.2 3.5 3.3 7-2.3 4.1-9.3 8.5-9.3 8.5z"})],-1)])],10,ye),c.p.image?(t(),s("img",{key:1,class:"prod-photo",src:c.p.image,alt:c.p.n,loading:"lazy"},null,8,we)):(t(),s("svg",{key:2,class:"prod",width:C.value,height:C.value,viewBox:F.value.viewBox,innerHTML:F.value.inner},null,8,ze))]),e("div",Fe,[e("b",null,i(c.p.n),1),e("small",null,i(c.p.d),1),d(be,{quantity:c.p.stockQty},null,8,["quantity"]),e("div",$e,[c.qty?(t(),s("div",{key:1,class:"qstep",role:"group","aria-label":`كمية ${c.p.n}`},[e("button",{class:"qstep__btn","aria-label":c.qty===1?"إزالة من السلة":"إنقاص الكمية",onClick:p[2]||(p[2]=x=>v.$emit("set-qty",c.p.id,c.qty-1))},[c.qty===1?(t(),s("svg",Ee,[...p[7]||(p[7]=[e("path",{d:"M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6"},null,-1)])])):(t(),s("svg",Me,[...p[8]||(p[8]=[e("path",{d:"M5 12h14"},null,-1)])]))],8,Be),e("span",Ae,i(c.qty),1),e("button",{class:"qstep__btn","aria-label":"زيادة الكمية",onClick:p[3]||(p[3]=x=>v.$emit("set-qty",c.p.id,c.qty+1))},[...p[9]||(p[9]=[e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.4"},[e("path",{d:"M12 5v14M5 12h14"})],-1)])])],8,_e)):(t(),s("button",{key:0,class:"addbtn","data-add":c.p.id,onClick:p[1]||(p[1]=x=>v.$emit("add",c.p.id,x))},[...p[6]||(p[6]=[e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8"},[e("path",{d:"M6 7h12l1.5 14h-15zM8 7a4 4 0 018 0"})],-1),g(" إضافة للسلة ",-1)])],8,Ce)),e("span",je,[g(i(r(D)(c.p.pr))+" ",1),p[10]||(p[10]=e("small",null,"ر.س",-1))])])])],4))}},ne=re(Se,[["__scopeId","data-v-ce0f4c95"]]),qe={class:"st-hero",id:"stHero"},Le={class:"in"},Te={class:"hero-ctas"},De={class:"hero-scene",id:"heroScene"},Ye={class:"hp-card hp-c1","data-depth":"16"},Pe={class:"fb"},Ie=["viewBox","innerHTML"],He={class:"hp-card hp-c2","data-depth":"26"},Ve={class:"fb"},Oe=["viewBox","innerHTML"],Re={class:"hp-card hp-c3","data-depth":"24"},Ne={class:"fb"},Qe=["viewBox","innerHTML"],Xe={class:"hp-badge hp-b1","data-depth":"34"},Ue={class:"bi2"},Ge={class:"hp-badge hp-b2","data-depth":"30"},Ke={class:"bi2"},We={class:"st-strip"},Ze={class:"si"},Je={class:"sec-line"},en={class:"cats"},nn=["data-cat","onClick"],rn={class:"ic-mini"},on={class:"ill",style:{background:"radial-gradient(70px 40px at 50% 85%,rgba(198,161,91,.28),transparent 65%),linear-gradient(150deg,#2A2318,#0F0C07)","border-radius":"11px"}},tn=["viewBox","innerHTML"],an={key:0,class:"store-promos"},sn={class:"store-promo__badge"},ln={class:"store-promo__txt"},dn=["data-promo"],pn={class:"sec-line"},gn={class:"best-wrap"},cn={class:"caro-btn r","data-caro":"1"},xn={class:"caro-btn l","data-caro":"-1"},bn={class:"best-caro",id:"bestCaro"},fn={class:"grid-tools"},mn={class:"gt-filter"},hn={class:"gt-count"},vn={class:"view-tg"},un={class:"gt-sort"},kn={key:1,class:"show-more"},yn={class:"perks",style:{"grid-template-columns":"repeat(4,1fr)","margin-top":"26px"}},wn={class:"pi"},zn={__name:"StoreCatalog",emits:["scroll-to-grid","add"],setup(c,{emit:E}){const{state:h,isFav:C,toggleFav:F,visibleProducts:v,setQty:p,products:x,categories:u}=W(),_=B=>h.cart[B]||0,l=P(()=>u.value.length?u.value.slice(1).concat(u.value[0]):[]),y=P(()=>x.value.filter(n=>h.cat==="all"||n.cat===h.cat).length),w=P(()=>x.value.filter(B=>B.best)),q=P(()=>Array.from({length:7},(B,n)=>({ch:n%3?"✦":"❖",style:`top:${10+n*13%75}%;${n%2?"right":"left"}:${4+n*9%42}%;animation-delay:-${n*.7}s`}))),H=B=>{const n=u.value.find(a=>a.id===B);return S(n?n.shape:"kit",52)},M=[["جودة مختارة بعناية","منتجات أصلية 100%",k.star],["تغليف فاخر","اهتمام بكل تفاصيل الطلب",k.box],["استلام من الفرع","جاهزة للاستلام من أقرب فرع",k.home],["إهداء سهل","أرسل المنتج أو الباقة كهدية",k.chat]],o=E;function L(B){h.cat=B,h.showAll=!1}function b(){h.showAll=!h.showAll}function O(B){h.view=B}return(B,n)=>(t(),s($,null,[e("section",qe,[n[26]||(n[26]=U('<svg class="veins" viewBox="0 0 800 430" preserveAspectRatio="none" fill="none"><path d="M-20 340 C160 300 240 380 420 330 S 700 250 830 300" stroke="rgba(198,161,91,.14)" stroke-width="1.2"></path><path d="M-20 120 C120 160 300 60 460 110 S 720 190 830 140" stroke="rgba(198,161,91,.1)" stroke-width="1"></path><path d="M100 430 C180 340 320 420 430 350" stroke="rgba(233,207,142,.08)" stroke-width="1"></path></svg><div class="hero-frame"></div>',2)),(t(!0),s($,null,Y(q.value,(a,A)=>(t(),s("span",{key:A,class:"hp",style:K(a.style)},i(a.ch),5))),128)),e("div",Le,[n[12]||(n[12]=e("span",{class:"eyebrow2"},[e("i"),g(" منتجات مختارة بعناية — جودة الصالون في منزلك")],-1)),n[13]||(n[13]=e("h1",null,[g("لتجربة يومية"),e("br"),e("span",{class:"g"},"استثنائيــــة")],-1)),n[14]||(n[14]=e("p",null,"منتجات فاخرة بجودة عالية لرجل يهتم بأدق التفاصيل — من العناية بالشعر واللحية إلى العطور الفاخرة.",-1)),e("div",Te,[e("button",{class:"btn btn-gold",id:"heroCta",onClick:n[0]||(n[0]=a=>o("scroll-to-grid"))},[n[11]||(n[11]=g("اكتشف المجموعة ",-1)),d(m,{inner:r(k).arrowL,size:15},null,8,["inner"])]),e("button",{class:"btn btn-outline-l",id:"heroBest",onClick:n[1]||(n[1]=a=>o("scroll-to-grid"))},"الأكثر مبيعًا")]),n[15]||(n[15]=e("div",{class:"hero-stats"},[e("div",{class:"hstat"},[e("b",null,"+30"),e("small",null,"منتج عناية فاخر")]),e("div",{class:"hstat"},[e("b",null,"100%"),e("small",null,"منتجات أصلية")]),e("div",{class:"hstat"},[e("b",null,"4.9 ★"),e("small",null,"تقييم عملائنا")])],-1))]),e("div",De,[n[24]||(n[24]=e("div",{class:"glow"},null,-1)),n[25]||(n[25]=e("div",{class:"ring2"},null,-1)),e("div",Ye,[n[16]||(n[16]=e("img",{src:me,alt:"زيت اللحية الذهبي",loading:"eager",onerror:"this.style.display='none';this.nextElementSibling.style.display='grid'"},null,-1)),e("div",Pe,[(t(),s("svg",{class:"prod",width:"90",height:"90",viewBox:r(S)("dropper",90).viewBox,innerHTML:r(S)("dropper",90).inner},null,8,Ie))]),n[17]||(n[17]=e("span",{class:"tag2"},"زيت اللحية الذهبي",-1))]),e("div",He,[n[18]||(n[18]=e("img",{src:he,alt:"مجموعة الترطيب والعناية",onerror:"this.style.display='none';this.nextElementSibling.style.display='grid'"},null,-1)),e("div",Ve,[(t(),s("svg",{class:"prod",width:"70",height:"70",viewBox:r(S)("jar",70).viewBox,innerHTML:r(S)("jar",70).inner},null,8,Oe))]),n[19]||(n[19]=e("span",{class:"tag2"},"مجموعة الترطيب والعناية",-1))]),e("div",Re,[n[20]||(n[20]=e("img",{src:ve,alt:"سيروم العناية بالبشرة",onerror:"this.style.display='none';this.nextElementSibling.style.display='grid'"},null,-1)),e("div",Ne,[(t(),s("svg",{class:"prod",width:"70",height:"70",viewBox:r(S)("pump",70).viewBox,innerHTML:r(S)("pump",70).inner},null,8,Qe))]),n[21]||(n[21]=e("span",{class:"tag2"},"سيروم العناية بالبشرة",-1))]),e("div",Xe,[e("span",Ue,[d(m,{inner:r(k).star,size:16},null,8,["inner"])]),n[22]||(n[22]=e("span",null,[e("b",null,"منتجات أصلية 100%"),e("small",null,"مختارة من عناية سامي")],-1))]),e("div",Ge,[e("span",Ke,[d(m,{inner:r(k).box,size:16},null,8,["inner"])]),n[23]||(n[23]=e("span",null,[e("b",null,"تغليف فاخر"),e("small",null,"اهتمام بكل تفاصيل الطلب")],-1))])])]),e("div",We,[e("span",Ze,[d(m,{inner:r(k).bag,size:19},null,8,["inner"])]),n[28]||(n[28]=e("p",null,"منتجات مختارة خصيصًا لتكمل تجربة عناية سامي داخل المنزل",-1)),e("button",{class:"btn btn-line",id:"stripCta",style:{padding:"11px 24px","font-size":"12.5px"},onClick:n[2]||(n[2]=a=>o("scroll-to-grid"))},[n[27]||(n[27]=g("تسوق المجموعة الكاملة ",-1)),d(m,{inner:r(k).arrowL,size:13},null,8,["inner"])])]),e("div",Je,[n[30]||(n[30]=e("h2",null,"تسوق حسب الفئة",-1)),e("a",{"data-cat":"all",onClick:n[3]||(n[3]=a=>L("all"))},[d(m,{inner:r(k).arrowL,size:13},null,8,["inner"]),n[29]||(n[29]=g(" عرض جميع الفئات",-1))])]),e("div",en,[(t(!0),s($,null,Y(l.value,a=>(t(),s("div",{key:a.id,class:j(["catc",{on:r(h).cat===a.id}]),"data-cat":a.id,onClick:A=>L(a.id)},[e("span",rn,[d(m,{inner:r(k).star,size:12},null,8,["inner"])]),e("div",on,[(t(),s("svg",{class:"prod",width:"52",height:"52",viewBox:H(a.id).viewBox,innerHTML:H(a.id).inner},null,8,tn))]),e("b",null,i(a.n),1)],10,nn))),128))]),r(ee).length?(t(),s("div",an,[(t(!0),s($,null,Y(r(ee),a=>(t(),s("div",{key:a.id,class:"store-promo"},[e("span",sn,i(a.badge),1),e("div",ln,[e("h3",null,i(a.title),1),e("p",null,i(a.text),1)]),e("button",{class:"btn btn-gold","data-promo":a.id,onClick:n[4]||(n[4]=A=>o("scroll-to-grid"))},[g(i(a.cta)+" ",1),d(m,{inner:r(k).arrowL,size:13},null,8,["inner"])],8,dn)]))),128))])):V("",!0),e("div",pn,[n[32]||(n[32]=e("h2",null,"الأكثر مبيعًا",-1)),e("a",{"data-showall":"1",onClick:n[5]||(n[5]=a=>r(h).showAll=!0)},[d(m,{inner:r(k).arrowL,size:13},null,8,["inner"]),n[31]||(n[31]=g(" عرض جميع المنتجات",-1))])]),e("div",gn,[e("button",cn,[d(m,{inner:r(k).chevR,size:15},null,8,["inner"])]),e("button",xn,[d(m,{inner:r(k).chevL,size:15},null,8,["inner"])]),e("div",bn,[(t(!0),s($,null,Y(w.value,(a,A)=>(t(),Q(ne,{key:a.id,p:a,index:A,view:r(h).view,fav:r(C)(a.id),qty:_(a.id),onToggleFav:r(F),onAdd:n[6]||(n[6]=(R,N)=>o("add",R,N)),onSetQty:r(p)},null,8,["p","index","view","fav","qty","onToggleFav","onSetQty"]))),128))])]),n[37]||(n[37]=e("div",{class:"sec-line"},[e("h2",null,"منتجات عناية سامي")],-1)),e("div",fn,[e("button",mn,[d(m,{inner:r(k).filter,size:15},null,8,["inner"]),n[33]||(n[33]=g(" تصفية المنتجات",-1))]),e("span",hn,"عرض 1 - "+i(r(v).length)+" من "+i(y.value)+" منتج",1),e("div",vn,[e("button",{class:j({on:r(h).view==="grid"}),"data-view":"grid","aria-label":"شبكة",onClick:n[7]||(n[7]=a=>O("grid"))},[d(m,{inner:r(k).grid,size:15},null,8,["inner"])],2),e("button",{class:j({on:r(h).view==="list"}),"data-view":"list","aria-label":"قائمة",onClick:n[8]||(n[8]=a=>O("list"))},[d(m,{inner:r(k).list,size:15},null,8,["inner"])],2)]),e("div",un,[n[35]||(n[35]=g("ترتيب ",-1)),X(e("select",{id:"sortSel","onUpdate:modelValue":n[9]||(n[9]=a=>r(h).sort=a)},[...n[34]||(n[34]=[e("option",{value:"new"},"الأحدث",-1),e("option",{value:"best"},"الأكثر مبيعًا",-1),e("option",{value:"low"},"السعر: الأقل أولًا",-1),e("option",{value:"high"},"السعر: الأعلى أولًا",-1)])],512),[[oe,r(h).sort]])])]),e("div",{class:j(["pgrid",{list:r(h).view==="list"}]),id:"pgrid"},[(t(!0),s($,null,Y(r(v),(a,A)=>(t(),Q(ne,{key:a.id,p:a,index:A,view:r(h).view,fav:r(C)(a.id),qty:_(a.id),onToggleFav:r(F),onAdd:n[10]||(n[10]=(R,N)=>o("add",R,N)),onSetQty:r(p)},null,8,["p","index","view","fav","qty","onToggleFav","onSetQty"]))),128))],2),y.value>8?(t(),s("div",kn,[e("button",{id:"moreBtn",onClick:b},[r(h).showAll?(t(),s($,{key:0},[n[36]||(n[36]=g("إخفاء المنتجات ",-1)),d(m,{inner:r(k).chevUp,size:14},null,8,["inner"])],64)):(t(),s($,{key:1},[g("عرض جميع المنتجات ("+i(y.value)+") ",1),d(m,{inner:r(k).chevDown,size:14},null,8,["inner"])],64))])])):V("",!0),e("div",yn,[(t(),s($,null,Y(M,(a,A)=>e("div",{key:A,class:"perk"},[e("span",wn,[d(m,{inner:a[2],size:17},null,8,["inner"])]),e("b",null,i(a[0]),1),e("small",null,i(a[1]),1)])),64))])],64))}},Fn={class:"g-stepper",style:{"padding-bottom":"0"}},$n={style:{display:"flex","align-items":"center",gap:"12px","justify-content":"center"}},Cn={class:"g-stage",style:{"padding-top":"6px"}},_n={class:"view on"},Bn={class:"card",style:{padding:"22px","margin-bottom":"14px"}},En={class:"fld",style:{margin:"0"}},Mn={class:"card",style:{padding:"22px","margin-bottom":"14px"}},An={class:"two"},jn={class:"fld",style:{margin:"0"}},Sn={class:"fld",style:{margin:"0"}},qn={class:"card",style:{padding:"22px"}},Ln=["data-ckpay"],Tn=["onClick"],Dn={class:"lg"},Yn={class:"tt"},Pn={key:0,style:{color:"#b42318","font-size":"12.5px",margin:"12px 0 0"}},In={class:"inline-actions"},Hn=["disabled"],Vn={class:"gsum"},On={class:"card",style:{padding:"20px"}},Rn={class:"thumb"},Nn=["viewBox","innerHTML"],Qn={class:"p"},Xn={style:{"margin-top":"12px","padding-top":"12px","border-top":"1px dashed var(--line)"}},Un={class:"gs-row",style:{border:"none",padding:"4px 0"}},Gn={class:"v"},Kn={class:"gs-row",style:{border:"none",padding:"4px 0"}},Wn={class:"v"},Zn={class:"gs-row",style:{border:"none",padding:"4px 0"}},Jn={class:"gs-total"},er={class:"v"},nr={class:"gs-note"},rr={__name:"StoreCheckout",emits:["back","placed"],setup(c,{emit:E}){const h=E,{state:C,cartItems:F,ckParts:v,ckCan:p,placeOrder:x}=W(),u=C.ck,_={arrowR:'<path d="M5 12h14M13 6l6 6-6 6"/>',lock:'<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/>',check:'<path d="M20 6L9 17l-5-5"/>'},l=M=>S(M,34),y=["cod","wallet","urpay"],w=T("");function q(M){y.includes(M.id)&&(u.pay=M.id)}async function H(){if(p.value){w.value="";try{await x(),h("placed")}catch(M){w.value=M.message||"تعذّر إتمام الطلب، حاول مرة أخرى"}}}return(M,o)=>{const L=te("RouterLink");return t(),s($,null,[e("div",Fn,[e("div",$n,[e("button",{class:"btn btn-prev",id:"backStore",style:{padding:"10px 20px","font-size":"12.5px"},onClick:o[0]||(o[0]=b=>h("back"))},[d(m,{inner:_.arrowR,size:14},null,8,["inner"]),o[7]||(o[7]=g(" العودة للمتجر",-1))])])]),o[26]||(o[26]=e("div",{class:"g-head",style:{"margin-top":"14px"}},[e("h1",null,"إتمام الطلب 🛍️"),e("p",null,"خطوة أخيرة وتصلك منتجاتك المختارة بعناية")],-1)),e("div",Cn,[e("main",_n,[e("div",Bn,[o[9]||(o[9]=e("h4",{style:{"font-family":"var(--font-d)","font-size":"16px",color:"var(--ink)","margin-bottom":"14px"}},"1️⃣ عنوان التوصيل",-1)),e("div",En,[o[8]||(o[8]=e("label",null,"العنوان",-1)),X(e("input",{id:"ckAddr",placeholder:"الحي، الشارع، رقم المبنى...","onUpdate:modelValue":o[1]||(o[1]=b=>r(u).addr=b)},null,512),[[G,r(u).addr]])])]),e("div",Mn,[o[12]||(o[12]=e("h4",{style:{"font-family":"var(--font-d)","font-size":"16px",color:"var(--ink)","margin-bottom":"14px"}},"2️⃣ بيانات العميل",-1)),e("div",An,[e("div",jn,[o[10]||(o[10]=e("label",null,"الاسم الكامل",-1)),X(e("input",{id:"ckName","onUpdate:modelValue":o[2]||(o[2]=b=>r(u).name=b)},null,512),[[G,r(u).name]])]),e("div",Sn,[o[11]||(o[11]=e("label",null,"رقم الجوال",-1)),X(e("input",{id:"ckPhone",dir:"ltr","onUpdate:modelValue":o[3]||(o[3]=b=>r(u).phone=b)},null,512),[[G,r(u).phone]])])])]),e("div",qn,[o[17]||(o[17]=e("h4",{style:{"font-family":"var(--font-d)","font-size":"16px",color:"var(--ink)","margin-bottom":"14px"}},"3️⃣ طريقة الدفع",-1)),(t(!0),s($,null,Y(r(ue),b=>(t(),s("div",{key:b.id,class:j(["acc-pm",{sel:r(u).pay===b.id,disabled:!y.includes(b.id)}]),"data-ckpay":b.id},[e("div",{class:"head",onClick:O=>q(b)},[e("span",Dn,i(b.logo),1),e("span",Yn,[e("b",null,i(b.n),1),e("small",null,i(y.includes(b.id)?b.d:"قريبًا"),1)]),o[13]||(o[13]=e("span",{class:"rad"},[e("i")],-1))],8,Tn)],10,Ln))),128)),w.value?(t(),s("p",Pn,i(w.value),1)):V("",!0),e("span",{class:j(["terms-chk",{on:r(u).terms}]),id:"ckTerms",onClick:o[5]||(o[5]=b=>r(u).terms=!r(u).terms)},[e("i",null,[d(m,{inner:_.check,size:11},null,8,["inner"])]),o[15]||(o[15]=g(" أوافق على ",-1)),d(L,{to:"/terms",onClick:o[4]||(o[4]=ie(()=>{},["stop"]))},{default:ae(()=>[...o[14]||(o[14]=[g("الشروط والأحكام وسياسة الاسترجاع",-1)])]),_:1})],2),e("div",In,[e("button",{class:"btn btn-prev",id:"backStore2",onClick:o[6]||(o[6]=b=>h("back"))},[d(m,{inner:_.arrowR,size:15},null,8,["inner"]),o[16]||(o[16]=g(" الرجوع للمتجر",-1))]),e("button",{class:"btn btn-gold",id:"placeOrder",disabled:!r(p)||r(C).placing,onClick:H},[d(m,{inner:_.lock,size:15},null,8,["inner"]),g(" "+i(r(C).placing?"جارٍ إتمام الطلب...":`إتمام الطلب — ${r(D)(r(v).total)} ر.س`),1)],8,Hn)]),o[18]||(o[18]=e("div",{class:"after-pay",style:{"font-size":"11.5px",color:"var(--mute)","text-align":"center","margin-top":"12px"}},"🔒 جميع عمليات الدفع آمنة ومشفرة",-1))])]),e("aside",null,[e("div",Vn,[e("div",On,[o[25]||(o[25]=e("h3",{style:{"font-family":"var(--font-d)","font-size":"17px",color:"var(--ink)","margin-bottom":"14px",display:"flex",gap:"10px","align-items":"center"}},[g("ملخص الطلب"),e("span",{style:{flex:"1",height:"1px",background:"linear-gradient(-90deg,var(--gold),transparent)"}})],-1)),(t(!0),s($,null,Y(r(F),b=>(t(),s("div",{key:b.id,class:"sum-item"},[e("span",Rn,[(t(),s("svg",{class:"prod",width:"34",height:"34",viewBox:l(b.shape).viewBox,innerHTML:l(b.shape).inner},null,8,Nn))]),e("span",null,[e("b",null,i(b.n),1),e("small",null,"الكمية: "+i(b.qty),1)]),e("span",Qn,i(r(D)(b.pr*b.qty))+" ر.س",1)]))),128)),e("div",Xn,[e("div",Un,[o[19]||(o[19]=e("span",{class:"k"},"المجموع الفرعي",-1)),e("span",Gn,i(r(D)(r(v).sub))+" ر.س",1)]),e("div",Kn,[o[20]||(o[20]=e("span",{class:"k"},"ضريبة القيمة المضافة (15%)",-1)),e("span",Wn,"+"+i(r(D)(r(v).vat))+" ر.س",1)]),e("div",Zn,[o[21]||(o[21]=e("span",{class:"k"},"رسوم التوصيل",-1)),e("span",{class:"v",style:K(r(v).ship?"":"color:var(--green)")},i(r(v).ship?"+"+r(D)(r(v).ship)+" ر.س":"مجانًا"),5)])]),e("div",Jn,[o[23]||(o[23]=e("span",{class:"k"},"الإجمالي",-1)),e("span",er,[g(i(r(D)(r(v).total))+" ",1),o[22]||(o[22]=e("small",{style:{"font-size":"13px"}},"ر.س",-1))])]),e("div",nr,[d(m,{inner:_.lock,size:14},null,8,["inner"]),o[24]||(o[24]=g(" الدفع آمن ومشفّر — بياناتك محمية بالكامل",-1))])])])])])],64)}}},or=re(rr,[["__scopeId","data-v-13b9c138"]]),tr={class:"gsuccess",style:{"max-width":"860px","margin-inline":"auto"}},ar={class:"gsuc-grid",style:{"grid-template-columns":"1.2fr 1fr"}},ir={class:"card gsuc-details"},sr={class:"gs-row"},lr={class:"k"},dr={class:"v",dir:"ltr"},pr={class:"gs-row"},gr={class:"k"},cr={class:"v"},xr={class:"gs-row"},br={class:"k"},fr={class:"v"},mr={class:"gs-row"},hr={class:"k"},vr={class:"v"},ur={class:"gs-row"},kr={class:"k"},yr={class:"gs-row"},wr={class:"k"},zr={class:"v",style:{color:"var(--gold-deep)","font-family":"var(--font-d)","font-size":"17px"}},Fr={class:"card gsuc-details"},$r={class:"thumb"},Cr=["viewBox","innerHTML"],_r={class:"p"},Br={class:"gsuc-actions"},Er={__name:"StoreSuccess",props:{order:{type:Object,required:!0}},emits:["back","track"],setup(c,{emit:E}){const h=c,C=E,F={qr:'<path d="M4 4h16v16H4z"/><path d="M9 9h2v2H9zM13 13h2v2h-2z"/>',user:'<path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/>',truck:'<path d="M1 3h15v13H1zM16 8h4l3 4v4h-7z"/><circle cx="6" cy="19" r="2"/><circle cx="19" cy="19" r="2"/>',card:'<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/>',check:'<path d="M20 6L9 17l-5-5"/>',lock:'<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/>',bag:'<path d="M6 7h12l1.5 14h-15zM8 7a4 4 0 018 0"/>'},v=P(()=>h.order),p=P(()=>h.order.parts),x=P(()=>v.value.items.reduce((_,l)=>_+l.q,0)),u=_=>S(_,34);return(_,l)=>(t(),s("div",tr,[l[11]||(l[11]=U('<div class="gsuc-head" style="margin-top:20px;"><h1>تم تأكيد طلبك بنجاح!</h1><span class="ic"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"></path></svg></span></div><p class="sub">سيصلك طلبك خلال 24-48 ساعة على العنوان المحدد — وسنرسل لك إشعارًا فور تجهيزه ✨</p>',2)),e("div",ar,[e("div",ir,[l[8]||(l[8]=e("h4",null,"تفاصيل الطلب",-1)),e("div",sr,[e("span",lr,[d(m,{inner:F.qr,size:14},null,8,["inner"]),l[2]||(l[2]=g(" رقم الطلب",-1))]),e("span",dr,i(v.value.ref),1)]),e("div",pr,[e("span",gr,[d(m,{inner:F.user,size:14},null,8,["inner"]),l[3]||(l[3]=g(" العميل",-1))]),e("span",cr,i(v.value.name),1)]),e("div",xr,[e("span",br,[d(m,{inner:F.truck,size:14},null,8,["inner"]),l[4]||(l[4]=g(" التوصيل",-1))]),e("span",fr,i(v.value.addr),1)]),e("div",mr,[e("span",hr,[d(m,{inner:F.card,size:14},null,8,["inner"]),l[5]||(l[5]=g(" طريقة الدفع",-1))]),e("span",vr,i(v.value.pay),1)]),e("div",ur,[e("span",kr,[d(m,{inner:F.check,size:14},null,8,["inner"]),l[6]||(l[6]=g(" حالة الطلب",-1))]),l[7]||(l[7]=e("span",{class:"v"},[e("span",{class:"chip"},"قيد التجهيز")],-1))]),e("div",yr,[e("span",wr,[d(m,{inner:F.lock,size:14},null,8,["inner"]),g(" المبلغ "+i(v.value.pay==="الدفع عند الاستلام"?"المستحق":"المدفوع"),1)]),e("span",zr,i(r(D)(p.value.total))+" ر.س",1)])]),e("div",Fr,[e("h4",null,"منتجاتك ("+i(x.value)+")",1),(t(!0),s($,null,Y(v.value.items,({p:y,q:w})=>(t(),s("div",{key:y.id,class:"sum-item"},[e("span",$r,[(t(),s("svg",{class:"prod",width:"34",height:"34",viewBox:u(y.shape).viewBox,innerHTML:u(y.shape).inner},null,8,Cr))]),e("span",null,[e("b",null,i(y.n),1),e("small",null,"الكمية: "+i(w),1)]),e("span",_r,i(r(D)(y.pr*w))+" ر.س",1)]))),128))])]),e("div",Br,[e("button",{class:"btn btn-gold",id:"backStore3",onClick:l[0]||(l[0]=y=>C("back"))},[d(m,{inner:F.bag,size:15},null,8,["inner"]),l[9]||(l[9]=g(" متابعة التسوق",-1))]),e("button",{class:"btn btn-line",id:"trackOrder",onClick:l[1]||(l[1]=y=>C("track"))},[d(m,{inner:F.truck,size:15},null,8,["inner"]),l[10]||(l[10]=g(" تتبع الطلب",-1))])]),l[12]||(l[12]=e("div",{class:"thanks"},[e("i",null,"❦"),g(" شكرًا لثقتك بمنتجات عناية سامي "),e("i",null,"❦")],-1))]))}},Mr={class:"shell"},Ar={class:"wrap",id:"storeApp"},jr={id:"contact",class:"site-footer"},Sr={class:"footer-content container"},qr={class:"sprod",id:"sheetProd"},Lr={class:"thumb"},Tr=["viewBox","innerHTML"],Dr={style:{flex:"1"}},Yr={class:"p"},Pr={class:"sacts"},Ir={id:"toastTopMsg"},Nr={__name:"StoreView",setup(c){const E=T(null),h=T(null),C=T(null),{locations:F,loadServiceLocations:v}=se();v();const{requireAuth:p}=le(),{state:x,cartQty:u,pOf:_,placeOrder:l}=W();ce(fe,"store"),xe(E);const y=T(!1),w=T(!1),q=T(null),H=T(!1),M=T(""),o=T(!1);function L(z){M.value=z,o.value=!0,clearTimeout(L._h),L._h=setTimeout(()=>{o.value=!1},2e3)}function b(){const z=h.value,f=C.value;!z||!f||(z.classList.remove("pop"),z.offsetWidth,z.classList.add("pop"),f.classList.remove("shake"),f.offsetWidth,f.classList.add("shake"),setTimeout(()=>z.classList.remove("pop"),350))}function O(z,f){x.cart[z]=(x.cart[z]||0)+1,ge(b),x.firstAdd?(x.firstAdd=!1,q.value=_(z),w.value=!0):L("تمت إضافة المنتج للسلة")}function B(){w.value=!1,y.value=!0}function n(){y.value=!1}function a(){n(),w.value=!1,x.page="checkout",x.ck.pay=null,x.ck.terms=!1,scrollTo({top:0,behavior:"smooth"})}function A(){x.page="store",scrollTo({top:0})}function R(){p(async()=>{H.value=!0;try{await l(),scrollTo({top:0,behavior:"smooth"})}catch(z){L(z.message||"تعذّر إتمام الطلب، حاول مرة أخرى")}finally{H.value=!1}})}function N(){const z=document.getElementById("pgrid");z&&z.scrollIntoView({behavior:"smooth",block:"start"})}J(()=>[x.page,u.value],()=>{x.page==="checkout"&&!u.value&&(x.page="store")}),J(()=>x.page,z=>{z!=="store"&&(w.value=!1)});const Z=()=>q.value?S(q.value.shape,46):null;return(z,f)=>(t(),s("div",{ref_key:"root",ref:E},[e("div",Mr,[e("div",Ar,[r(x).page==="store"?(t(),Q(zn,{key:0,onScrollToGrid:N,onAdd:O})):r(x).page==="checkout"?(t(),Q(or,{key:1,onBack:A,onPlaced:R})):r(x).page==="success"&&r(x).order?(t(),Q(Er,{key:2,order:r(x).order,onBack:A,onTrack:f[0]||(f[0]=I=>L("حالة طلبك "+r(x).order.ref+": قيد التجهيز"))},null,8,["order"])):V("",!0)])]),e("footer",jr,[e("div",Sr,[f[6]||(f[6]=e("div",null,[e("h3",null,"تواصل معنا"),e("form",{class:"phone-form",onsubmit:"return false"},[e("span",null,"+966"),e("input",{type:"tel",placeholder:"رقم الجوال"})]),e("a",{class:"whatsapp",href:"https://wa.me/966566101963"},"تواصل واتساب ◉")],-1)),f[7]||(f[7]=U('<div><h3>عن سامي</h3><a href="/">الرئيسية</a><a href="/booking">خدماتنا</a><a href="/store">المنتجات</a><a href="/packages-gifts">الباقات</a></div><div class="footer-brand"><a href="/"><img src="'+pe+'" alt="عناية سامي"></a></div><div><h3>مساعدة</h3><a href="/contact">اتصل معنا</a><a href="#">الشكاوى والاقتراحات</a><a href="#">سياسة الخصوصية</a><a href="#">الشروط والأحكام</a></div>',3)),e("div",null,[f[5]||(f[5]=e("h3",null,"عناوين الفروع",-1)),(t(!0),s($,null,Y(r(F),I=>(t(),s($,{key:I.id},[e("b",null,i(I.name),1),e("p",null,[g(i(I.address),1),I.contact_number?(t(),s($,{key:0},[f[4]||(f[4]=e("br",null,null,-1)),g(i(I.contact_number),1)],64)):V("",!0)])],64))),128))])]),f[8]||(f[8]=e("p",{class:"copyright"},"© 2026 عناية سامي. جميع الحقوق محفوظة.",-1))]),e("div",{class:j(["sheet-ov",{on:w.value}]),id:"sheetOv",onClick:f[1]||(f[1]=I=>w.value=!1)},null,2),e("div",{class:j(["sheet",{on:w.value}]),id:"sheet"},[f[9]||(f[9]=U('<div class="grab"></div><div class="shead"><span class="si"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 7h12l1.5 14h-15zM8 7a4 4 0 018 0"></path><path d="M9.5 13.5l1.8 1.8 3.4-3.4"></path></svg></span><b>تم إضافة المنتج</b></div>',2)),e("div",qr,[q.value?(t(),s($,{key:0},[e("span",Lr,[(t(),s("svg",{class:"prod",width:"46",height:"46",viewBox:Z().viewBox,innerHTML:Z().inner},null,8,Tr))]),e("span",Dr,[e("b",null,i(q.value.n),1),e("span",Yr,i(r(D)(q.value.pr))+" ر.س",1)])],64)):V("",!0)]),e("div",Pr,[e("button",{class:"btn btn-line",id:"sheetCont",onClick:f[2]||(f[2]=I=>w.value=!1)},"متابعة التسوق"),e("button",{class:"btn btn-gold",id:"sheetView",onClick:f[3]||(f[3]=I=>{w.value=!1,B()})},"عرض السلة")])],2),d(de,{open:y.value,onClose:n,onCheckout:a},null,8,["open"]),e("div",{class:j(["pay-loading",{on:H.value}]),id:"payLoading"},[...f[10]||(f[10]=[e("div",{class:"pl-box"},[e("div",{class:"pl-ring"}),e("b",null,"جارٍ معالجة طلبك بأمان…"),e("small",null,"لا تغلق الصفحة، سيتم تأكيد طلبك خلال لحظات")],-1)])],2),e("div",{class:j(["toast-top",{on:o.value}]),id:"toastTop"},[f[11]||(f[11]=e("span",{class:"ti"},[e("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"3"},[e("path",{d:"M20 6L9 17l-5-5"})])],-1)),e("span",Ir,i(M.value),1)],2)],512))}};export{Nr as default};
