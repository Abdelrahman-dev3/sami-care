import{r as b,h as m,c as a,b as r,u as s,p as u,F as v,e as w,d as k,o as i,q as p,t,a as e,w as y,B as z}from"./index-DE6Dokyg.js";import{u as B,a as C}from"./useInternalLinks-6-kCyq0D.js";import{P as E}from"./PageSkeleton-DQLY7cgQ.js";import"./SkeletonLoader-Bg6Q_aWd.js";const F=`\r
:root{\r
...
`,_={class:"shell"},A={class:"wrap"},D={key:1,class:"branches-grid"},j={class:"branch-img"},L=["src","alt"],S={class:"branch-info"},V={class:"branch-meta"},M={key:0},Y={key:1},P={key:2},N=["onClick"],J={__name:"BranchesView",setup(I){const d=b(null),{locations:g,locationsLoading:c,loadServiceLocations:x,setLocation:f}=m();B(F,"branches"),C(d),x();function h(l){f(l.id),location.href="/booking"}return(l,o)=>(i(),a("div",{ref_key:"root",ref:d,class:""},[r("div",_,[r("div",A,[o[4]||(o[4]=r("div",{class:"page-head"},[r("h1",null,"فروعنا الفاخرة"),r("p",null,"اختر الفرع الأقرب إليك لبدء حجز خدماتك. فروعنا مجهزة بالكامل لتقدم لك أرقى تجارب العناية والاسترخاء.")],-1)),s(c)?(i(),u(E,{key:0,variant:"list"})):(i(),a("div",D,[(i(!0),a(v,null,w(s(g),n=>(i(),a("div",{key:n.id,class:"branch-card"},[r("div",j,[n.image?(i(),a("img",{key:0,src:n.image,alt:n.name},null,8,L)):p("",!0)]),r("div",S,[r("h3",null,t(n.name),1),r("div",V,[r("span",null,[o[0]||(o[0]=r("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[r("path",{d:"M21 10c0 7-9 12-9 12S3 17 3 10a9 9 0 0118 0z"}),r("circle",{cx:"12",cy:"10",r:"3"})],-1)),e(t(n.address),1)]),n.home?(i(),a("span",M,[...o[1]||(o[1]=[r("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[r("path",{d:"M3 9l9-6 9 6v11a1 1 0 01-1 1H4a1 1 0 01-1-1z"}),r("path",{d:"M9 21V12h6v9"})],-1),e("خدمة VIP",-1)])])):n.contact_number?(i(),a("span",Y,[o[2]||(o[2]=r("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[r("path",{d:"M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.362 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.338 1.85.573 2.81.7A2 2 0 0122 16.92z"})],-1)),e(t(n.contact_number),1)])):p("",!0),n.rating_star?(i(),a("span",P,[o[3]||(o[3]=r("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[r("path",{d:"M12 2l2.9 6.2 6.6.8-4.9 4.6 1.3 6.6L12 17l-5.9 3.2 1.3-6.6L2.5 9l6.6-.8z"})],-1)),e("تقييم "+t(n.rating_star),1)])):p("",!0)])]),r("a",{href:"#",class:"btn btn-gold",style:{width:"100%"},onClick:y(H=>h(n),["prevent"])},t(n.home?"احجز الخدمة المنزلية":"احجز في هذا الفرع"),9,N)]))),128))]))])]),k(z)],512))}};export{J as default};
