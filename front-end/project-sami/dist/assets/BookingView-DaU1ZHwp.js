import{B as Sr,C as Tr,u as n,o as t,c as s,b as r,F as D,e as W,n as I,t as l,h as hr,r as Z,v as zr,D as Or,i as m,j as Gr,q as H,a as C,d as kr,x as _r,k as Ur,E as wr,G as pr,m as mr,w as Dr,s as Yr,H as Wr,z as Rr,_ as Kr,I as Xr,J as Jr,K as Qr,p as gr,L as Zr}from"./index-BqeKzWTr.js";import{u as re,a as ee}from"./useInternalLinks-eDrG6Sfd.js";import{u as sr,r as O,f as ur,a as ar,b as jr}from"./useBooking-kmprPrwg.js";import{f as ne,a as qr,b as te,v as ae,c as oe,i as ie}from"./bookingApi-DYM3KCEq.js";import{s as se}from"./serviceDetails-gQMMCHKA.js";import{c as Ir,a as Br,b as Hr}from"./giftIcons-C3hH12nn.js";import{l as le}from"./i18nField-CJ_3XKph.js";import{_ as Lr}from"./SkeletonLoader-BEpaTLHQ.js";import{f as de}from"./accountApi-DcakfKCW.js";const pe=`\r
:root{\r
...
`,Vr=[{id:"s1",cat:"hair",name:"حلاقة عادية",desc:"حلاقة شعر عادية بقصات عصرية",dur:20,price:20},{id:"s2",cat:"hair",name:"حلاقة شعر + تحديد لحية",desc:"حلاقة شعر مع تحديد اللحية",dur:30,price:35},{id:"s3",cat:"hair",name:"حلاقة مع غسيل",desc:"حلاقة مع غسيل وتنظيف الشعر",dur:30,price:30},{id:"s4",cat:"hair",name:"حلاقة VIP",desc:"حلاقة فاخرة مع خدمة VIP",dur:50,price:80},{id:"s5",cat:"hair",name:"تنسيق اللحية",desc:"تنسيق وتجميل اللحية",dur:20,price:15},{id:"s6",cat:"hair",name:"تصفيف الشعر",desc:"تصفيف الشعر بالمنتجات المناسبة",dur:15,price:15},{id:"s7",cat:"skin",name:"تنظيف بشرة عميق",desc:"تنظيف عميق ينظف وينعش البشرة",dur:50,price:150},{id:"s8",cat:"skin",name:"تنظيف بشرة سريع",desc:"جلسة سريعة لإشراقة فورية",dur:30,price:80},{id:"s9",cat:"skin",name:"ماسك الذهب",desc:"ماسك فاخر لنضارة استثنائية",dur:25,price:90},{id:"s10",cat:"pedi",name:"بديكير عادي",desc:"عناية أساسية للأقدام والأظافر",dur:45,price:60},{id:"s11",cat:"pedi",name:"بديكير فاخر",desc:"عناية متكاملة مع تقشير وترطيب",dur:60,price:100},{id:"s12",cat:"pedi",name:"بديكير طبي",desc:"علاج تشققات القدم والمسامير",dur:60,price:120},{id:"s13",cat:"pedi",name:"إزالة جلد ميت",desc:"إزالة الجلد الميت من القدمين",dur:30,price:40},{id:"s14",cat:"mass",name:"مساج استرخاء للجسم",desc:"استرخاء عميق يجدد طاقتك",dur:60,price:180},{id:"s15",cat:"mass",name:"مساج رأس",desc:"جلسة قصيرة لتخفيف التوتر",dur:15,price:25},{id:"s16",cat:"mass",name:"مساج علاجي",desc:"مساج متخصص للعضلات المجهدة",dur:60,price:220},{id:"s17",cat:"bath",name:"حمام مغربي كلاسيكي",desc:"تقشير وتنقية بطقوس أصيلة",dur:60,price:200},{id:"s18",cat:"bath",name:"حمام مغربي ملكي",desc:"التجربة الكاملة مع ماسك وتدليك",dur:90,price:300}];for(const rr of Object.values(se))for(const e of rr.variants||[])e.svcId&&!Vr.some(z=>z.id===e.svcId)&&Vr.push({id:e.svcId,cat:e.cat,name:e.name,desc:e.desc||"",dur:e.dur,price:e.price,hidden:!0});const ce=[{id:"u1",name:"كريم ترطيب متوازن",desc:"ترطيب وتغذية يدوم طويلًا",price:110,img:"https://sami-care.sa//storage/uploads/403/HyxbPuOgHBgbg0pgpMZr9bcFv2OryQtxjRMLnhxb.jpg"},{id:"u2",name:"غسول تنظيف البشرة",desc:"ينظف بعمق وينعش البشرة",price:95,img:"https://sami-care.sa//storage/uploads/405/L2sxjQjZgTztP0swgRTlXV0jVjCLuS5GJyypCJmT.jpg"},{id:"u3",name:"زيت اللحية الذهبي",desc:"ترطيب وتغذية عميقة",price:120,img:"https://sami-care.sa//storage/uploads/406/uGGoLhrbcMofuyS2kedJ44ejvBqYnz1M0mA0zTMP.jpg"}],ge=[{t:"اختيار الخدمات",ic:'<circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M20 4L8.12 15.88M14.47 14.48L20 20M8.12 8.12L12 12"/>'},{t:"اختيار الموظف",ic:'<path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/>'},{t:"اختيار الوقت",ic:'<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/>'},{t:"تأكيد الحجز",ic:'<path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/>'},{t:"الدفع",ic:'<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/>'}],ue={class:"wrap stepper",id:"stepperWrap"},xe={class:"steps",id:"steps"},me=["data-i"],he={class:"n"},be=["onClick"],fe=["innerHTML"],ve={__name:"BookingStepper",setup(rr){const{state:e}=sr();function z(v){v<e.step&&(e.step=v)}return(v,S)=>Sr((t(),s("div",ue,[r("div",xe,[(t(!0),s(D,null,W(n(ge),(L,M)=>(t(),s("div",{key:M,class:I(["step",{active:M===n(e).step,done:M<n(e).step}]),"data-i":M},[S[0]||(S[0]=r("div",{class:"bar"},[r("i")],-1)),r("span",he,l(M+1),1),r("span",{class:"bubble",onClick:x=>z(M)},[(t(),s("svg",{width:"21",height:"21",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.7",innerHTML:L.ic},null,8,fe))],8,be),r("label",null,l(L.t),1)],10,me))),128))])],512)),[[Tr,!n(e).done]])}},ye={key:0,class:"branch-strip"},we=["src","alt"],ke={class:"bi"},_e={key:1,class:"empty-hint",style:{display:"grid",gap:"10px"}},ze={class:"cat-row"},$e=["data-cat","onClick"],Me=["src","alt"],Ce={class:"lbl"},Fe={class:"cat-name"},Se={key:0,class:"empty-hint"},Be={key:1,class:"sub-block"},Le={class:"sub-title"},Ee={class:"sub-title__main"},Ae={class:"tick"},Te=["innerHTML"],De={key:0,class:"empty-hint"},je={key:1,class:"subs"},Ie=["data-svc","onClick"],He={class:"top"},Ne={class:"si"},Pe=["innerHTML"],Ve={class:"foot"},Ye={class:"dur"},Re={class:"prc"},qe={__name:"ServicesStep",setup(rr){const{state:e,hasSvc:z,toggleSvc:v}=sr(),{current:S}=hr(),{state:L}=Ur(),M=o=>le(o,L.lang),x=Z([]),P=Z(!0);zr(async()=>{try{const o=await Or();x.value=o!=null&&o.status?o.data||[]:[]}catch{x.value=[]}finally{P.value=!1}});const j=m(()=>x.value.map(o=>({id:o.id,name:M(o.name),image:Gr(o.image)||o.feature_image||null}))),A=m(()=>x.value.find(o=>o.id===e.activeCat)||null),V=m(()=>{var o;return M((o=A.value)==null?void 0:o.name)}),y=m(()=>Ir(A.value)),B=m(()=>{var o;return(((o=A.value)==null?void 0:o.services)||[]).map(p=>({id:p.id,categoryId:A.value.id,categoryName:V.value,icon:y.value,name:M(p.name),desc:M(p.description)||"",dur:p.duration_min,price:p.default_price}))}),E=o=>e.services.some(p=>p.categoryId===o),T=m(()=>B.value.filter(o=>z(o.id)).length),$=o=>({"--acc":Hr(o.icon)}),h=o=>Br(o.icon);return(o,p)=>(t(),s(D,null,[p[5]||(p[5]=r("div",{class:"panel-head"},[r("h1",null,"اختر الخدمة التي تناسبك"),r("p",null,"يمكنك اختيار خدمة واحدة أو أكثر من أي قسم")],-1)),n(S)?(t(),s("div",ye,[n(S).image?(t(),s("img",{key:0,src:n(S).image,alt:n(S).name},null,8,we)):H("",!0),r("span",ke,[p[0]||(p[0]=C("مكان التنفيذ: ",-1)),r("b",null,l(n(S).name),1),r("small",null,l(n(S).address),1)])])):H("",!0),P.value?(t(),s("div",_e,[kr(Lr,{height:"64px","border-radius":"12px"}),kr(Lr,{height:"92px","border-radius":"12px"})])):(t(),s(D,{key:2},[r("div",ze,[(t(!0),s(D,null,W(j.value,_=>(t(),s("div",{key:_.id,class:I(["cat",{sel:n(e).activeCat===_.id,"has-picks":E(_.id)}]),"data-cat":_.id,onClick:G=>n(e).activeCat=_.id},[_.image?(t(),s("img",{key:0,src:_.image,alt:_.name},null,8,Me)):H("",!0),p[1]||(p[1]=r("span",{class:"chk"},[r("svg",{width:"9",height:"9",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"3"},[r("path",{d:"M20 6L9 17l-5-5"})])],-1)),r("span",Ce,[r("span",Fe,l(_.name),1)])],10,$e))),128))]),n(e).activeCat?(t(),s("div",Be,[r("div",Le,[r("span",Ee,[C(" خدمات "+l(V.value)+" ",1),r("span",Ae,[(t(),s("svg",{viewBox:"0 0 24 24","aria-hidden":"true",innerHTML:n(Br)(y.value)},null,8,Te))])]),r("small",null,l(T.value?T.value+" مختارة":"اختر خدمة أو أكثر"),1)]),B.value.length?(t(),s("div",je,[(t(!0),s(D,null,W(B.value,_=>(t(),s("div",{key:_.id,class:I(["sub",{sel:n(z)(_.id)}]),"data-svc":_.id,style:_r($(_)),onClick:G=>n(v)(_)},[r("div",He,[r("span",Ne,[(t(),s("svg",{viewBox:"0 0 24 24","aria-hidden":"true",innerHTML:h(_)},null,8,Pe))]),r("b",null,l(_.name),1),p[3]||(p[3]=r("span",{class:"chk"},[r("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"3"},[r("path",{d:"M20 6L9 17l-5-5"})])],-1))]),r("small",null,l(_.desc),1),r("div",Ve,[r("span",Ye,"🕐 "+l(_.dur)+" دقيقة",1),r("span",Re,[C(l(n(O)(_.price))+" ",1),p[4]||(p[4]=r("small",null,"ر.س",-1))])])],14,Ie))),128))])):(t(),s("div",De,"لا توجد خدمات متاحة حاليًا ضمن هذا القسم"))])):(t(),s("div",Se,[...p[2]||(p[2]=[r("b",null,"اختر خدمة لعرض تفاصيلها",-1),C("اختر إحدى الخدمات الأساسية أعلاه لعرض الخدمات الفرعية المتاحة",-1)])]))],64))],64))}},Oe={class:"mode-grid"},Ge={key:0,class:"emp-section emp-section--groups"},Ue={class:"emp-cat emp-cat--group"},We={class:"cat-ico"},Ke=["innerHTML"],Xe={class:"emp-cat__info"},Je={class:"emp-cat__services"},Qe={key:0,class:"empty-hint"},Ze={key:1,class:"empty-hint"},rn={key:2,class:"emp-list emp-list--groups"},en=["onClick"],nn=["onClick"],tn={key:1,class:"j-note card",style:{display:"flex",gap:"16px","align-items":"center",padding:"20px 24px","border-color":"var(--line)"}},an={__name:"EmployeeStep",setup(rr){const{state:e,selSvcs:z,setEmployee:v}=sr(),{current:S}=hr(),L=wr({}),M=wr({}),x=["توفير الوقت","أفضل تقييم متاح","تنفيذ خدمات القسم بنفس الموظف","منع أي تعارض في المواعيد"],P=["اختر موظفًا واحدًا لكل قسم","الموظف المختار ينفذ كل خدمات القسم","تحكم كامل في فريق جلستك"],j=m(()=>{const g=new Map;return z.value.forEach(c=>{const u=String(c.categoryId??c.categoryName??c.id);g.has(u)||g.set(u,{id:u,name:c.categoryName||c.name,icon:c.icon||Ir(c.categoryId),services:[]}),g.get(u).services.push(c)}),[...g.values()]});function A(g){return[g.first_name,g.last_name].filter(Boolean).join(" ")||g.username||"موظف"}function V(g){return{"--acc":Hr(g.icon)}}function y(g){return`${g.services.length} ${g.services.length===1?"خدمة":"خدمات"}`}function B(g){return g.services.map(c=>c.name).join("، ")}function E(g){const c=g.services.map(w=>L[w.id]);if(!c.length||c.some(w=>!Array.isArray(w)))return[];const[u,...b]=c,f=u.filter(w=>b.every(U=>U.some(R=>String(R.id)===String(w.id))));return[...new Map(f.map(w=>[String(w.id),w])).values()]}function T(g){return g.services.some(c=>M[c.id]||!Array.isArray(L[c.id]))}function $(g){const c=g.services.map(b=>e.emp[b.id]).filter(Boolean);if(c.length!==g.services.length)return null;const u=c[0];return c.every(b=>String(b.id)===String(u.id))?u:null}function h(g,c){var u;return String(((u=$(g))==null?void 0:u.id)??"")===String(c.id??"")}function o(g){const c=g.services.map(u=>z.value.findIndex(b=>String(b.id)===String(u.id))).filter(u=>u>=0);return c.length?Math.min(...c):-1}function p(g){const c=o(g);c!==-1&&z.value.slice(c).forEach(u=>{delete e.time[u.id]})}function _(g,c,{clearTimes:u=!0}={}){g.services.forEach(b=>v(b.id,c)),u&&p(g)}function G(){e.mode==="auto"&&j.value.forEach(g=>{E(g).length&&g.services.forEach(u=>{e.staffOptions[u.id]=L[u.id]||[],v(u.id,{id:null,name:"اختيار تلقائي"})})})}function Y(g){const c=e.mode!==g;e.mode=g,c&&(e.time={},e.emp={}),G()}function F(g,c){e.mode="manual",_(g,c)}async function K(g){var c,u;if(!L[g.id]){M[g.id]=!0;try{const b=(c=S.value)!=null&&c.home?0:(u=S.value)==null?void 0:u.id,f=await ne({branchId:b,serviceId:g.id}),w=(Array.isArray(f)?f:[]).map(U=>({id:U.id,name:A(U)}));L[g.id]=[...new Map(w.map(U=>[String(U.id),U])).values()],e.staffOptions[g.id]=L[g.id],G()}catch{L[g.id]=[]}finally{M[g.id]=!1}}}function er(){z.value.forEach(K)}return zr(er),pr(()=>z.value.map(g=>g.id),er),pr(()=>e.mode,G),(g,c)=>(t(),s(D,null,[c[10]||(c[10]=r("div",{class:"panel-head"},[r("h1",null,"اختر الموظف"),r("p",null,"اختر موظفًا واحدًا لكل قسم، وسيتم تطبيقه على كل الخدمات المختارة داخل هذا القسم")],-1)),r("div",Oe,[r("div",{class:I(["mode dark",{sel:n(e).mode==="auto"}]),onClick:c[0]||(c[0]=u=>Y("auto"))},[c[3]||(c[3]=mr('<span class="chk"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6L9 17l-5-5"></path></svg></span><span class="mi"><svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="8" r="4"></circle><path d="M5 21c0-4 3-6 7-6s7 2 7 6"></path></svg></span><h3>اختيار تلقائي</h3><div class="sub-t">سنختار لك أفضل فريق متاح</div><span class="flag">★ موصى به</span>',5)),r("ul",null,[(t(),s(D,null,W(x,(u,b)=>r("li",{key:b},[c[2]||(c[2]=r("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.6"},[r("path",{d:"M20 6L9 17l-5-5"})],-1)),C(" "+l(u),1)])),64))])],2),r("div",{class:I(["mode",{sel:n(e).mode==="manual"}]),onClick:c[1]||(c[1]=u=>Y("manual"))},[c[5]||(c[5]=mr('<span class="chk"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--ink)" stroke-width="3"><path d="M20 6L9 17l-5-5"></path></svg></span><span class="mi"><svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg></span><h3>اختيار موظف محدد</h3><div class="sub-t">اختر موظفًا لكل قسم</div><span class="flag">تحكم كامل</span>',5)),r("ul",null,[(t(),s(D,null,W(P,(u,b)=>r("li",{key:b},[c[4]||(c[4]=r("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.6"},[r("path",{d:"M20 6L9 17l-5-5"})],-1)),C(" "+l(u),1)])),64))])],2)]),n(e).mode==="manual"?(t(),s("div",Ge,[(t(!0),s(D,null,W(j.value,u=>(t(),s("div",{key:u.id,class:"emp-row emp-row--group",style:_r(V(u))},[r("div",Ue,[r("span",We,[(t(),s("svg",{viewBox:"0 0 24 24","aria-hidden":"true",innerHTML:n(Br)(u.icon)},null,8,Ke))]),r("span",Xe,[r("b",null,l(u.name),1),r("small",null,l(y(u)),1),r("span",Je,l(B(u)),1)])]),T(u)?(t(),s("div",Qe,[kr(Lr,{height:"44px","border-radius":"8px"})])):E(u).length?(t(),s("div",rn,[r("button",{type:"button",class:"emp any",onClick:Dr(b=>F(u,E(u)[0]),["stop"])},[...c[6]||(c[6]=[mr('<span class="av" aria-hidden="true"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg></span><b>أي موظف</b><span class="rate">الأنسب تلقائيًا</span>',3)])],8,en),(t(!0),s(D,null,W(E(u),b=>(t(),s("button",{key:b.id,type:"button",class:I(["emp",{sel:h(u,b)}]),onClick:Dr(f=>F(u,b),["stop"])},[c[7]||(c[7]=r("span",{class:"chk"},[r("svg",{width:"11",height:"11",viewBox:"0 0 24 24",fill:"none",stroke:"#fff","stroke-width":"3"},[r("path",{d:"M20 6L9 17l-5-5"})])],-1)),c[8]||(c[8]=r("span",{class:"av","aria-hidden":"true"},null,-1)),r("b",null,l(b.name),1)],10,nn))),128))])):(t(),s("div",Ze,"لا يوجد موظف متاح يمكنه تنفيذ كل خدمات هذا القسم"))],4))),128))])):H("",!0),n(e).mode==="auto"?(t(),s("div",tn,[...c[9]||(c[9]=[mr('<span style="flex:none;width:44px;height:44px;border-radius:13px;display:grid;place-items:center;background:linear-gradient(135deg,var(--gold-bright),var(--gold));color:var(--ink);"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M13 2L3 14h9l-1 8 10-12h-9z"></path></svg></span><p style="font-size:13.5px;color:#5c5442;line-height:1.9;"><b style="color:var(--ink);">تم اختيار موظف واحد مناسب لكل قسم تلقائيًا.</b> سيتم تنفيذ كل خدمات القسم بنفس الموظف، وتقدر تشوف الأوقات في الخطوة الجاية.</p>',2)])])):H("",!0)],64))}},on={class:"card branch-strip"},sn={class:"cells"},ln={class:"cell"},dn={class:"cell"},pn={class:"loyalty-preview","aria-live":"polite"},cn={class:"card cal"},gn={class:"cal-head"},un={class:"cal-cells"},xn=["disabled","onClick"],mn={class:"dow"},hn={class:"dnum"},bn={key:0,class:"empty-hint",style:{"margin-top":"10px"}},fn={class:"date-line"},vn={class:"card detail-card time-start-card",style:{"margin-top":"14px"}},yn={class:"periods booking-periods"},wn={key:1,class:"empty-hint"},kn={key:2,class:"empty-hint"},_n={key:3,class:"empty-hint"},zn={key:4,class:"slots initial-slots"},$n=["onClick"],Mn={key:0,class:"tag"},Cn={key:5,class:"best-slot"},Fn={key:0,class:"session-plan"},Sn={class:"plan-track"},Bn={key:0,class:"plan-gap"},Ln={class:"plan-icon"},En=["innerHTML"],An={class:"t"},Tn={key:0,class:"plan-note plan-note--pending"},Dn={key:1,class:"plan-note plan-note--warn"},jn={key:2,class:"plan-note"},In={__name:"TimeStep",setup(rr){const e=["الأحد","الاثنين","الثلاثاء","الأربعاء","الخميس","الجمعة","السبت"],z=["يناير","فبراير","مارس","أبريل","مايو","يونيو","يوليو","أغسطس","سبتمبر","أكتوبر","نوفمبر","ديسمبر"],{state:v,selSvcs:S,totalDur:L,priceParts:M,setEmployee:x,setTime:P}=sr(),j=Z(5),A=m(()=>Math.floor(M.value.total/100)*j.value),V=new Date;V.setHours(0,0,0,0);const y=Z(new Date(V)),B=Z("all"),E=wr({}),T=wr({}),$=wr({}),h=m(()=>Array.from({length:7},(i,a)=>{const d=new Date(y.value);return d.setDate(d.getDate()+a),d}));m(()=>y.value.getTime()<=V.getTime());const o=m(()=>{const i=h.value;return i[0].getMonth()===i[6].getMonth()?`${i[0].getDate()} - ${i[6].getDate()} ${z[i[0].getMonth()]}`:`${i[0].getDate()} ${z[i[0].getMonth()]} - ${i[6].getDate()} ${z[i[6].getMonth()]}`}),p=i=>i<V,_=i=>v.date&&i.getTime()===v.date.getTime(),G=m(()=>{const i=new Map;return S.value.forEach(a=>{const d=String(a.categoryId??a.categoryName??a.id);i.has(d)||i.set(d,{id:d,name:a.categoryName||a.name,icon:a.icon||Ir(a.categoryId),services:[]}),i.get(d).services.push(a)}),[...i.values()]}),Y=m(()=>G.value.flatMap(i=>i.services)),F=m(()=>Y.value[0]||null);m(()=>G.value[0]||null);const K=m(()=>F.value?v.time[F.value.id]:"");function er(i){return`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}-${String(i.getDate()).padStart(2,"0")}`}function g(i){if(!i||typeof i!="string")return null;const[a,d]=i.split(":").map(Number);return!Number.isFinite(a)||!Number.isFinite(d)?null:a*60+d}function c(i){if(!Number.isFinite(i))return"";const a=1440,d=(Math.round(i)%a+a)%a;return`${String(Math.floor(d/60)).padStart(2,"0")}:${String(d%60).padStart(2,"0")}`}function u(i){return[...new Set((Array.isArray(i)?i:[]).filter(a=>g(a)!==null))].sort((a,d)=>g(a)-g(d))}function b(i){Y.value.slice(i).forEach(a=>{delete v.time[a.id]})}function f(i,{apply:a=!1}={}){var tr;const d=g(i),N=Y.value;if(!N.length||d===null)return{complete:!1,rows:[],end:""};let Q=d;const J=[];for(let dr=0;dr<N.length;dr++){const q=N[dr],or=u(E[q.id]),ir=dr===0?or.includes(i)?i:or.find(cr=>g(cr)>=Q):or.find(cr=>g(cr)>=Q);if(!ir){a&&b(dr);const cr=J[J.length-1];return{complete:!1,rows:J,missing:q,end:(cr==null?void 0:cr.end)||""}}const Nr=g(ir),Pr=Nr+(Number(q.dur)||0);J.push({service:q,start:ir,end:c(Pr),expected:c(Q),shifted:Nr>Q}),a&&P(q.id,ir),a&&v.mode==="auto"&&((tr=T[q.id])!=null&&tr[ir])&&x(q.id,T[q.id][ir]),Q=Pr}return{complete:!0,rows:J,end:c(Q)}}function w(){K.value&&f(K.value,{apply:!0})}function U(i){f(i,{apply:!0})}function R(i){return{"--acc":Hr(i.icon)}}function k(i){return i.services.reduce((a,d)=>a+(Number(d.dur)||0),0)}function X(i){const a=i.services.map(N=>v.emp[N.id]).filter(Boolean);if(!a.length)return null;const d=a[0];return a.every(N=>String(N.id)===String(d.id)),d}function nr(i){return`${i.services.length} ${i.services.length===1?"خدمة":"خدمات"}`}function $r(i){p(i)||(v.date=i,v.time={},Object.keys(E).forEach(a=>{delete E[a]}))}async function xr(i){var N;const a=v.emp[i.id];if(!v.date||!a){delete E[i.id];return}const d=er(v.date);$[i.id]=!0;try{const Q=v.mode==="auto"?v.staffOptions[i.id]||[]:[a],J=await Promise.all(Q.filter(q=>(q==null?void 0:q.id)!=null).map(async q=>({candidate:q,times:await te({date:d,staffId:q.id,durationMin:i.dur}).catch(()=>[])}))),tr={};J.forEach(({candidate:q,times:or})=>{u(or).forEach(ir=>{tr[ir]||(tr[ir]=q)})});const dr=Object.keys(tr);v.date&&er(v.date)===d&&((N=v.emp[i.id])==null?void 0:N.id)===a.id&&(E[i.id]=u(dr),T[i.id]=tr,w())}catch{E[i.id]=[],w()}finally{$[i.id]=!1}}pr(()=>v.date,()=>{B.value="all",S.value.forEach(xr)}),pr(()=>S.value.map(i=>{var a;return`${i.id}:${(a=v.emp[i.id])==null?void 0:a.id}`}),()=>S.value.forEach(xr)),zr(async()=>{var i;S.value.forEach(xr);try{const a=await qr();j.value=Math.max(Number((i=a==null?void 0:a.data)==null?void 0:i.points_per_100)||5,1)}catch{}});const Mr=m(()=>v.date?`${e[v.date.getDay()]} ${v.date.getDate()} ${z[v.date.getMonth()]} ${v.date.getFullYear()}`:"اختر تاريخًا من التقويم"),br=m(()=>F.value&&$[F.value.id]),fr=m(()=>F.value?u(E[F.value.id]):[]),Cr=m(()=>fr.value.filter(i=>{const a=g(i);return B.value==="am"?a<720:B.value==="pm"?a>=720:!0})),Er=m(()=>!!v.date&&Y.value.every(i=>Array.isArray(E[i.id])&&!$[i.id])),Fr=m(()=>!!K.value&&Y.value.some(i=>$[i.id]||!Array.isArray(E[i.id]))),vr=m(()=>K.value?Y.value.find(i=>!v.time[i.id]):null),lr=m(()=>Er.value&&fr.value.find(i=>f(i).complete)||""),yr=m(()=>{const i=[];let a=null;return G.value.forEach(d=>{const N=d.services.map(or=>g(v.time[or.id])),Q=N.every(or=>or!==null),J=N[0];if(!Q){i.push({type:"group",key:`group-${d.id}`,group:d,name:d.name,icon:d.icon,style:R(d),duration:k(d),services:d.services,employee:X(d),pending:!0});return}a!==null&&J>a&&i.push({type:"gap",key:`gap-${i.length}`,start:c(a),end:c(J),duration:J-a});const tr=d.services[d.services.length-1],q=g(v.time[tr.id])+(Number(tr.dur)||0);i.push({type:"group",key:`group-${d.id}`,group:d,name:d.name,icon:d.icon,style:R(d),start:c(J),end:c(q),duration:k(d),services:d.services,employee:X(d),pending:!1}),a=q}),i}),Ar=m(()=>{const i=yr.value.filter(d=>d.type==="group"&&!d.pending),a=i[i.length-1];return(a==null?void 0:a.end)||""});return(i,a)=>(t(),s(D,null,[a[17]||(a[17]=r("div",{class:"panel-head"},[r("h1",null,"اختر وقت بداية الجلسة"),r("p",null,"اختر أول موعد فقط، وسيتم ترتيب باقي الأقسام تلقائيًا حسب مدة كل قسم والأوقات المتاحة.")],-1)),r("div",on,[a[6]||(a[6]=r("div",{class:"bi"},[r("b",null,"ملخص جلستك"),r("small",null,"قبل اختيار الوقت")],-1)),r("div",sn,[r("div",ln,[r("b",null,l(n(S).length),1),a[4]||(a[4]=C("الخدمات",-1))]),r("div",dn,[r("b",null,l(n(ur)(n(L))),1),a[5]||(a[5]=C("المدة الإجمالية",-1))])])]),r("div",pn,[a[9]||(a[9]=r("h3",null,[r("span",{"aria-hidden":"true"},"✨"),C(" مكافأة نقاط الولاء لهذه الجلسة")],-1)),r("p",null,[a[7]||(a[7]=C("ستحصل على ",-1)),r("b",null,l(n(O)(A.value))+" نقطة ولاء",1),a[8]||(a[8]=C(" عند إتمام هذا الحجز.",-1))]),r("strong",null,"يمنحك نظام الولاء "+l(n(O)(j.value))+" نقطة مقابل كل 100 ر.س مدفوعة.",1)]),r("div",cn,[r("div",gn,[r("b",null,l(o.value),1)]),r("div",un,[(t(!0),s(D,null,W(h.value,(d,N)=>(t(),s("button",{key:N,disabled:p(d),class:I({sel:_(d),avail:!p(d)}),onClick:Q=>$r(d)},[r("span",mn,l(e[d.getDay()].slice(0,3)),1),r("span",hn,l(d.getDate()),1)],10,xn))),128))]),a[10]||(a[10]=r("div",{class:"cal-legend"},[r("span",null,[r("i",{style:{background:"var(--green)"}}),C(" تتوفر مواعيد")]),r("span",null,[r("i",{style:{background:"#D8D0BC"}}),C(" غير متاح")])],-1))]),n(v).date?(t(),s(D,{key:1},[r("div",fn,"📅 "+l(Mr.value),1),r("div",vn,[a[13]||(a[13]=r("h4",null,[C("وقت بداية الجلسة "),r("small",{style:{"font-weight":"400",color:"var(--mute)"}},"سننسق باقي الأقسام بعده")],-1)),H("",!0),r("div",yn,[r("button",{class:I(["period",{sel:B.value==="all"}]),onClick:a[0]||(a[0]=d=>B.value="all")},"🗓️ كل اليوم",2),r("button",{class:I(["period",{sel:B.value==="am"}]),onClick:a[1]||(a[1]=d=>B.value="am")},"☀️ صباحًا",2),r("button",{class:I(["period",{sel:B.value==="pm"}]),onClick:a[2]||(a[2]=d=>B.value="pm")},"🌇 مساءً",2)]),a[14]||(a[14]=r("div",{class:"available-times-title"},"الأوقات المتاحة",-1)),br.value||F.value&&!Array.isArray(E[F.value.id])?(t(),s("div",wn,[kr(Lr,{height:"44px","border-radius":"8px"})])):fr.value.length?Cr.value.length?(t(),s("div",zn,[(t(!0),s(D,null,W(Cr.value,d=>(t(),s("button",{key:d,class:I(["slot",{sel:K.value===d}]),onClick:N=>U(d)},[lr.value===d?(t(),s("span",Mn,"الأفضل")):H("",!0),C(" "+l(n(ar)(d)),1)],10,$n))),128))])):(t(),s("div",_n,"لا توجد أوقات في هذه الفترة")):(t(),s("div",kn,"لا توجد أوقات متاحة لهذا اليوم")),lr.value&&K.value!==lr.value?(t(),s("div",Cn,[r("span",null,[a[12]||(a[12]=C("أفضل بداية متاحة اليوم: ",-1)),r("b",null,l(n(ar)(lr.value)),1)]),r("button",{onClick:a[3]||(a[3]=d=>U(lr.value))},"اختيار")])):H("",!0)]),K.value?(t(),s("div",Fn,[a[16]||(a[16]=r("h4",null,[r("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[r("path",{d:"M13 2L3 14h7l-1 8 10-12h-7l1-8z"})]),C(" خطة تنفيذ الجلسة ")],-1)),r("div",Sn,[(t(!0),s(D,null,W(yr.value,d=>{var N;return t(),s(D,{key:d.key},[d.type==="gap"?(t(),s("div",Bn,[a[15]||(a[15]=r("span",null,"فاصل انتظار",-1)),r("b",null,l(n(ar)(d.start))+" - "+l(n(ar)(d.end)),1),r("small",null,l(n(ur)(d.duration)),1)])):(t(),s("div",{key:1,class:I(["plan-item plan-item--group",{pending:d.pending}]),style:_r(d.style)},[r("span",Ln,[(t(),s("svg",{viewBox:"0 0 24 24","aria-hidden":"true",innerHTML:n(Br)(d.icon)},null,8,En))]),r("b",null,l(d.name),1),r("small",null,"مع "+l(((N=d.employee)==null?void 0:N.name)||"-"),1),r("span",An,l(d.pending?"بانتظار وقت متاح":`${n(ar)(d.start)} - ${n(ar)(d.end)}`),1),r("small",null,l(nr(d.group))+" · "+l(n(ur)(d.duration)),1)],6))],64)}),128))]),Fr.value?(t(),s("div",Tn,"جاري تنسيق باقي الأقسام حسب الأوقات المتاحة.")):vr.value?(t(),s("div",Dn,"لم نجد وقتًا متاحًا لـ "+l(vr.value.name)+" بعد هذا الموعد. اختر بداية أبكر أو يومًا آخر.",1)):(t(),s("div",jn,"تم تنسيق الجلسة تلقائيًا، والنهاية المتوقعة "+l(n(ar)(Ar.value))+".",1))])):H("",!0)],64)):(t(),s("div",bn,[...a[11]||(a[11]=[r("b",null,"ابدأ باختيار التاريخ",-1),C("اختر يومًا من التقويم لعرض الأوقات المتاحة",-1)])]))],64))}},Hn={class:"card detail-card"},Nn={class:"d-grid"},Pn={class:"d-cell"},Vn={class:"d-cell"},Yn={class:"d-cell"},Rn={class:"d-cell"},qn={class:"card detail-card"},On={class:"timeline-cards"},Gn={class:"tl-main"},Un={class:"with"},Wn={class:"tl-time"},Kn={class:"tm"},Xn={class:"dr"},Jn={key:0,class:"card detail-card products-detail-card"},Qn={class:"upsell"},Zn=["src","alt"],rt={class:"inf"},et={class:"p"},nt=["disabled","onClick"],tt={__name:"ConfirmStep",setup(rr){const{state:e,selSvcs:z,totalDur:v}=sr(),{current:S}=hr(),{user:L,isAuthenticated:M}=Yr(),{state:x,products:P,addToCart:j,setQty:A}=Wr();zr(()=>{M.value&&L.value&&!e.cust.name&&(e.cust.name=[L.value.first_name,L.value.last_name].filter(Boolean).join(" "),e.cust.phone=L.value.mobile||"",e.cust.mail=L.value.email||"")});const V=m(()=>e.date?jr(e.date):""),y=m(()=>{const $=new Map;z.value.forEach(o=>{const p=String(o.categoryId??o.categoryName??o.id);$.has(p)||$.set(p,{id:p,name:o.categoryName||o.name,services:[]}),$.get(p).services.push(o)});const h=o=>{if(!o)return Number.MAX_SAFE_INTEGER;const[p,_]=String(o).split(":").map(Number);return Number.isFinite(p)&&Number.isFinite(_)?p*60+_:Number.MAX_SAFE_INTEGER};return[...$.values()].map(o=>{var G;const p=[...o.services].sort((Y,F)=>h(e.time[Y.id])-h(e.time[F.id])),_=[...new Set(p.map(Y=>{var F;return(F=e.emp[Y.id])==null?void 0:F.name}).filter(Boolean))];return{...o,services:p,start:e.time[(G=p[0])==null?void 0:G.id]||"",duration:p.reduce((Y,F)=>Y+(Number(F.dur)||0),0),price:p.reduce((Y,F)=>Y+(Number(F.price)||0),0),employees:_}}).sort((o,p)=>h(o.start)-h(p.start))}),B=m(()=>{const $=P.value.slice(0,3);return $.length?$.map(h=>({id:h.id,name:h.n,desc:h.d,price:h.pr,img:h.image||h.img||"/images/generated/products/care-set-card-hq.png"})):ce.map(h=>({id:null,name:h.name,desc:h.desc,price:h.price,img:h.img||"/images/generated/products/care-set-card-hq.png"}))});function E($){return $.id!=null&&!!x.cart[$.id]}function T($){$.id!=null&&(E($)?A($.id,0):j($.id))}return($,h)=>{var o;return Rr("RouterLink"),t(),s(D,null,[h[20]||(h[20]=r("div",{class:"panel-head"},[r("h1",null,"تأكيد الحجز"),r("p",null,"راجع تفاصيل جلستك قبل تأكيد الحجز والدفع")],-1)),r("div",Hn,[h[8]||(h[8]=r("h4",null,[r("svg",{width:"17",height:"17",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8"},[r("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2"}),r("path",{d:"M16 2v4M8 2v4M3 10h18"})]),C(" تفاصيل الموعد")],-1)),r("div",Nn,[r("div",Pn,[h[4]||(h[4]=r("small",null,"📍 الفرع",-1)),r("b",null,l(((o=n(S))==null?void 0:o.name)||"—"),1)]),r("div",Vn,[h[5]||(h[5]=r("small",null,"📅 التاريخ",-1)),r("b",null,l(V.value),1)]),r("div",Yn,[h[6]||(h[6]=r("small",null,"⏱️ المدة الإجمالية",-1)),r("b",null,l(n(ur)(n(v))),1)]),r("div",Rn,[h[7]||(h[7]=r("small",null,"✂️ عدد الخدمات",-1)),r("b",null,l(n(z).length),1)])])]),r("div",qn,[h[9]||(h[9]=r("h4",null,[r("svg",{width:"17",height:"17",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8"},[r("circle",{cx:"12",cy:"12",r:"9"}),r("path",{d:"M12 7v5l3 3"})]),C(" تفاصيل الجلسة")],-1)),r("div",On,[(t(!0),s(D,null,W(y.value,p=>(t(),s("div",{key:p.id,class:"tl"},[r("div",Gn,[r("b",null,l(p.name),1),r("div",Un,"مع "+l(p.employees.join("، ")||"—"),1)]),r("div",Wn,[r("span",Kn,l(n(ar)(p.start)),1),r("span",Xn,l(p.duration)+" دقيقة · "+l(n(O)(p.price))+" ر.س",1)])]))),128))])]),B.value.length?(t(),s("div",Jn,[h[10]||(h[10]=r("h4",null,[r("svg",{width:"17",height:"17",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8"},[r("path",{d:"M12 2l2.9 6.2 6.6.8-4.9 4.6 1.3 6.6L12 17l-5.9 3.2 1.3-6.6L2.5 9l6.6-.8z"})]),C(" منتجات مناسبة لجلستك")],-1)),r("div",Qn,[(t(!0),s(D,null,W(B.value,p=>(t(),s("div",{key:p.id||p.name,class:I(["up",{added:E(p)}])},[r("img",{src:p.img,alt:p.name,loading:"lazy"},null,8,Zn),r("span",rt,[r("b",null,l(p.name),1),r("small",null,l(p.desc),1),r("span",et,l(n(O)(p.price))+" ر.س",1)]),r("button",{type:"button",disabled:p.id==null,onClick:_=>T(p)},l(E(p)?"✓ أضيف":"إضافة"),9,nt)],2))),128))])])):H("",!0),H("",!0)],64)}}},at={class:"card detail-card"},ot={class:"pay-methods"},it=["onClick"],st={class:"pmi"},lt={class:"card detail-card payment-rewards-card"},dt={class:"rewards"},pt={class:"rt"},ct={class:"ri"},gt=["innerHTML"],ut=["max","value","disabled"],xt={class:"hint"},mt={class:"rt"},ht={class:"ri"},bt=["innerHTML"],ft=["max","value","disabled"],vt={class:"hint"},yt={class:"coupon"},wt={class:"ci"},kt=["innerHTML"],_t=["onKeydown"],zt=["disabled"],$t={class:"reward-total"},Mt={key:0},Ct={class:"trust-row"},Ft={class:"ti"},St=["innerHTML"],Bt={__name:"PayStep",setup(rr){const{state:e,priceParts:z,pointValue:v,couponDiscount:S,walletDiscount:L,loyaltyPointsUsed:M,loyaltyDiscount:x,payableTotal:P}=sr(),j=Z(!1);zr(async()=>{var b,f;try{const w=await de(),U=((b=w==null?void 0:w.data)==null?void 0:b.balances)||{};e.walletBalance=Number(U.wallet??0),e.loyaltyPoints=Number(U.loyalty_points??0)}catch{}try{const w=await qr();e.pointValue=Number(((f=w==null?void 0:w.data)==null?void 0:f.point_value)??.5)||.5}catch{}});const A=m(()=>Math.max(Number(e.walletBalance)||0,0)),V=m(()=>Math.max(parseInt(e.loyaltyPoints,10)||0,0)),y=m(()=>Math.max(z.value.total-S.value,0)),B=m(()=>Math.min(L.value,y.value)),E=m(()=>Math.max(z.value.total-S.value-B.value,0)),T=m(()=>Math.min(V.value,Math.ceil(E.value/v.value))),$=m(()=>B.value>0||M.value>0),h=m(()=>[{id:"cod",n:"الدفع عند الوصول",d:$.value?"غير متاح مع خصم المحفظة أو النقاط":"ادفع عند وصولك للفرع",logo:"COD",enabled:!$.value},{id:"mada",n:"مدى",d:"قريبًا",logo:"مدى",enabled:!1},{id:"card",n:"بطاقات الائتمان والخصم",d:$.value?"ادفع المتبقي بعد الخصومات":"قريبًا — Visa / Mastercard",logo:"VISA",enabled:$.value&&P.value>0},{id:"tabby",n:"تابي",d:"قريبًا",logo:"tabby",enabled:!1}]);pr([$,P],()=>{$.value&&e.pay==="cod"&&(e.pay=P.value>0?"card":null),e.pay==="wallet"&&walletInsufficient.value&&(e.pay=null)});const o=[["ضمان الجودة","نضمن لك أفضل تجربة",'<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/>'],["دفع آمن","تقنيات تشفير متقدمة",'<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/>'],["حماية البيانات","بياناتك محمية بالكامل",'<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>'],["دعم فوري","فريق دعم جاهز لخدمتك",'<path d="M3 18v-6a9 9 0 0118 0v6"/><path d="M21 19a2 2 0 01-2 2h-1a2 2 0 01-2-2v-3a2 2 0 012-2h3zM3 19a2 2 0 002 2h1a2 2 0 002-2v-3a2 2 0 00-2-2H3z"/>']],p={wallet:'<path d="M18 8V7a2 2 0 00-2-2H5a2 2 0 000 4h14a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2V7"/><path d="M16 13h.01"/>',gift:'<path d="M20 12v8H4v-8"/><path d="M2 7h20v5H2z"/><path d="M12 22V7"/><path d="M12 7H7.5a2.5 2.5 0 110-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 100-5C13 2 12 7 12 7z"/>',coupon:'<path d="M4 7a2 2 0 012-2h12a2 2 0 012 2v3a2 2 0 000 4v3a2 2 0 01-2 2H6a2 2 0 01-2-2v-3a2 2 0 000-4z"/><path d="M9 9h.01M15 15h.01M16 8l-8 8"/>'};function _(b){b.enabled&&(e.pay=b.id)}function G(b,f){const w=Number(b);return Number.isFinite(w)?Math.max(0,Math.min(w,f)):0}function Y(){e.rewards.useWallet=!e.rewards.useWallet,e.rewards.useWallet?e.rewards.walletAmount=G(e.rewards.walletAmount||y.value,Math.min(A.value,y.value)):e.rewards.walletAmount=0}function F(b){e.rewards.walletAmount=G(b,Math.min(A.value,y.value)),e.rewards.useWallet=e.rewards.walletAmount>0}function K(){e.rewards.useLoyalty=!e.rewards.useLoyalty,e.rewards.useLoyalty?e.rewards.loyaltyPoints=Math.min(e.rewards.loyaltyPoints||T.value,T.value):e.rewards.loyaltyPoints=0}function er(b){const f=Math.max(0,Math.min(parseInt(b,10)||0,T.value));e.rewards.loyaltyPoints=f,e.rewards.useLoyalty=f>0}function g(b){const w=(b==null?void 0:b.discount_type)==="percent"?z.value.total*(Number(b==null?void 0:b.discount_percentage)||0)/100:Number(b==null?void 0:b.discount_amount)||0;return Math.min(Math.max(w,0),z.value.total)}async function c(){const b=e.rewards.couponCode.trim();if(!b){e.rewards.couponStatus="bad",e.rewards.couponMessage="أدخل كود الخصم أولًا";return}j.value=!0;try{const f=await ae(b);if(!(f!=null&&f.valid)){e.rewards.couponApplied="",e.rewards.couponDiscount=0,e.rewards.couponStatus="bad",e.rewards.couponMessage="كود الخصم غير صالح";return}const w=g(f);e.rewards.couponCode=b,e.rewards.couponApplied=b,e.rewards.couponDiscount=w,e.rewards.couponStatus="ok",e.rewards.couponMessage=`تم تطبيق خصم ${O(Math.round(w))} ر.س`}catch(f){e.rewards.couponStatus="bad",e.rewards.couponMessage=f.message||"تعذّر التحقق من الكوبون"}finally{j.value=!1}}function u(){e.rewards.couponApplied="",e.rewards.couponDiscount=0,e.rewards.couponStatus="",e.rewards.couponMessage=""}return pr([A,y],()=>{e.rewards.useWallet&&F(e.rewards.walletAmount)}),pr(T,()=>{e.rewards.useLoyalty&&er(e.rewards.loyaltyPoints)}),(b,f)=>(t(),s(D,null,[f[11]||(f[11]=r("div",{class:"panel-head"},[r("h1",null,"الدفع"),r("p",null,"اختر طريقة الدفع المناسبة وأكمل حجزك")],-1)),r("div",at,[f[5]||(f[5]=r("h4",null,"اختر طريقة الدفع",-1)),r("div",ot,[(t(!0),s(D,null,W(h.value,w=>(t(),s("div",{key:w.id,class:I(["pm",{sel:n(e).pay===w.id,disabled:!w.enabled}]),onClick:U=>_(w)},[r("span",st,l(w.logo),1),r("span",null,[r("b",null,l(w.n),1),r("small",null,l(w.d),1)]),f[4]||(f[4]=r("span",{class:"rad"},[r("i")],-1))],10,it))),128))]),f[6]||(f[6]=r("div",{class:"secure-line"},"🔒 جميع عمليات الدفع آمنة ومشفرة",-1))]),r("div",lt,[f[10]||(f[10]=r("h4",null,[r("span",{class:"step-dot"},"2"),C(" استخدام العروض و المكافآت")],-1)),r("div",dt,[r("div",{class:I(["rw",{on:n(e).rewards.useWallet}])},[r("div",pt,[r("span",ct,[(t(),s("svg",{width:"19",height:"19",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:p.wallet},null,8,gt))]),r("span",null,[f[7]||(f[7]=r("b",null,"استخدام من المحفظة",-1)),r("small",null,"الرصيد الحالي: "+l(n(O)(A.value))+" ر.س",1)]),r("span",{class:I(["switch",{on:n(e).rewards.useWallet}]),onClick:Y},null,2)]),r("input",{type:"number",min:"0",max:Math.min(A.value,y.value),step:"1",value:n(e).rewards.walletAmount,disabled:!n(e).rewards.useWallet,onInput:f[0]||(f[0]=w=>F(w.target.value))},null,40,ut),r("span",xt,"المبلغ المتاح حتى "+l(n(O)(Math.round(Math.min(A.value,y.value))))+" ر.س",1)],2),r("div",{class:I(["rw",{on:n(e).rewards.useLoyalty}])},[r("div",mt,[r("span",ht,[(t(),s("svg",{width:"19",height:"19",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:p.gift},null,8,bt))]),r("span",null,[f[8]||(f[8]=r("b",null,"استخدام نقاط الولاء",-1)),r("small",null,"لديك "+l(n(O)(V.value))+" نقطة",1)]),r("span",{class:I(["switch",{on:n(e).rewards.useLoyalty}]),onClick:K},null,2)]),r("input",{type:"number",min:"0",max:T.value,step:"1",value:n(e).rewards.loyaltyPoints,disabled:!n(e).rewards.useLoyalty,onInput:f[1]||(f[1]=w=>er(w.target.value))},null,40,ft),r("span",vt,"تساوي خصم "+l(n(O)(Math.round(n(M)*n(v))))+" ر.س",1)],2)]),r("div",yt,[r("span",wt,[(t(),s("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:p.coupon},null,8,kt))]),Sr(r("input",{"onUpdate:modelValue":f[2]||(f[2]=w=>n(e).rewards.couponCode=w),placeholder:"أدخل كود الخصم",onInput:f[3]||(f[3]=w=>n(e).rewards.couponApplied&&n(e).rewards.couponCode!==n(e).rewards.couponApplied?u():null),onKeydown:Jr(Dr(c,["prevent"]),["enter"])},null,40,_t),[[Xr,n(e).rewards.couponCode]]),n(e).rewards.couponApplied?(t(),s("button",{key:0,type:"button",class:"coupon-clear",onClick:u},"إلغاء")):H("",!0),r("button",{type:"button",onClick:c,disabled:j.value},l(j.value?"...":"تطبيق"),9,zt)]),n(e).rewards.couponMessage?(t(),s("p",{key:0,class:I(["coupon-msg",n(e).rewards.couponStatus])},l(n(e).rewards.couponMessage),3)):H("",!0),r("div",$t,[f[9]||(f[9]=r("span",null,"المبلغ بعد المكافآت",-1)),r("b",null,l(n(O)(Math.round(n(P))))+" ر.س",1),n(S)||B.value||n(x)?(t(),s("small",Mt," تم خصم "+l(n(O)(Math.round(n(S)+B.value+n(x))))+" ر.س ",1)):H("",!0)])]),r("div",Ct,[(t(),s(D,null,W(o,(w,U)=>r("div",{key:U,class:"trust"},[r("span",Ft,[(t(),s("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.7",innerHTML:w[2]},null,8,St))]),r("b",null,l(w[0]),1),r("small",null,l(w[1]),1)])),64))])],64))}},Lt=Kr(Bt,[["__scopeId","data-v-28a25545"]]),Et={class:"success-wrap"},At={class:"suc-grid"},Tt={class:"card suc-details"},Dt={class:"sd-row"},jt={class:"k"},It=["innerHTML"],Ht={class:"v"},Nt={class:"sd-row"},Pt={class:"k"},Vt=["innerHTML"],Yt={class:"v"},Rt={class:"sd-row"},qt={class:"k"},Ot=["innerHTML"],Gt={class:"v"},Ut={class:"sd-row"},Wt={class:"k"},Kt=["innerHTML"],Xt={class:"v"},Jt={class:"sd-row"},Qt={class:"k"},Zt=["innerHTML"],ra={class:"v"},ea={class:"sd-row"},na={class:"k"},ta=["innerHTML"],aa={class:"card qr-card"},oa={class:"code"},ia={class:"qr-box"},sa=["src"],la=["href"],da={class:"suc-actions"},pa={class:"suc-perks"},ca={class:"ti"},ga=["innerHTML"],ua="color:var(--gold-deep);font-family:var(--font-d);font-size:17px",xa={__name:"BookingSuccess",emits:["home","calendar","share"],setup(rr,{emit:e}){const{state:z,selSvcs:v,totalDur:S,priceParts:L}=sr(),{current:M}=hr(),x=e,P=m(()=>L.value),j=m(()=>z.date?jr(z.date):""),A=m(()=>[...new Set(v.value.map(h=>{var o;return(o=z.emp[h.id])==null?void 0:o.name}).filter(Boolean))]),V=m(()=>{var h;return{r:z.bookRef||"",b:((h=M.value)==null?void 0:h.name)||"",d:j.value,u:ur(S.value),e:A.value.join("، "),p:P.value.total,s:v.value.map(o=>{var p;return[o.name,ar(z.time[o.id]),((p=z.emp[o.id])==null?void 0:p.name)||"",o.price]})}}),y=m(()=>{const h=JSON.stringify(V.value);return btoa(unescape(encodeURIComponent(h))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}),B=m(()=>`${window.location.origin}/booking?receipt=${y.value}`),E=m(()=>`https://api.qrserver.com/v1/create-qr-code/?size=220x220&margin=12&data=${encodeURIComponent(B.value)}`),T={pin:'<path d="M21 10c0 7-9 12-9 12S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/>',cal:'<rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/>',info:'<circle cx="12" cy="12" r="9"/><path d="M12 8v4M12 16h.01"/>',scis:'<circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M20 4L8.12 15.88M14.47 14.48L20 20M8.12 8.12L12 12"/>',user:'<path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/>',card:'<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/>'},$=[["خدمة VIP","تجربة فاخرة مصممة لراحتك",'<path d="M2 8l4 4 6-8 6 8 4-4v10a2 2 0 01-2 2H4a2 2 0 01-2-2z"/>'],["بياناتك آمنة","نضمن لك خصوصية وأمان بياناتك",'<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>'],["تعديل الحجز","يمكنك تعديل أو إلغاء الحجز قبل موعده",'<rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/>'],["دعم عملاء 24/7","نحن هنا لخدمتك دائمًا",'<path d="M3 18v-6a9 9 0 0118 0v6"/><path d="M21 19a2 2 0 01-2 2h-1a2 2 0 01-2-2v-3a2 2 0 012-2h3zM3 19a2 2 0 002 2h1a2 2 0 002-2v-3a2 2 0 00-2-2H3z"/>']];return(h,o)=>{var p;return t(),s("div",Et,[o[15]||(o[15]=mr('<div class="suc-ic"><span class="spark s1">✦</span><span class="spark s2">✧</span><svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M20 6L9 17l-5-5"></path></svg></div><h1>تم تأكيد حجزك بنجاح!</h1><p class="sub">نتطلع لخدمتك وتقديم تجربة استثنائية تليق بك</p>',3)),r("div",At,[r("div",Tt,[o[9]||(o[9]=r("h4",null,"تفاصيل الحجز",-1)),r("div",Dt,[r("span",jt,[(t(),s("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:T.pin},null,8,It)),o[3]||(o[3]=C(" الفرع",-1))]),r("span",Ht,l(((p=n(M))==null?void 0:p.name)||"—"),1)]),r("div",Nt,[r("span",Pt,[(t(),s("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:T.cal},null,8,Vt)),o[4]||(o[4]=C(" التاريخ",-1))]),r("span",Yt,l(j.value),1)]),r("div",Rt,[r("span",qt,[(t(),s("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:T.info},null,8,Ot)),o[5]||(o[5]=C(" مدة الجلسة",-1))]),r("span",Gt,l(n(ur)(n(S))),1)]),r("div",Ut,[r("span",Wt,[(t(),s("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:T.scis},null,8,Kt)),o[6]||(o[6]=C(" الخدمات",-1))]),r("span",Xt,l(n(v).map(_=>`${_.name} (${n(ar)(n(z).time[_.id])})`).join(" + ")),1)]),r("div",Jt,[r("span",Qt,[(t(),s("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:T.user},null,8,Zt)),o[7]||(o[7]=C(" الفريق",-1))]),r("span",ra,l(A.value.join("، ")),1)]),r("div",ea,[r("span",na,[(t(),s("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",innerHTML:T.card},null,8,ta)),o[8]||(o[8]=C(" المبلغ التقديري",-1))]),r("span",{class:"v",style:ua},l(n(O)(P.value.total))+" ر.س",1)])]),r("div",aa,[o[10]||(o[10]=r("h4",{style:{"font-family":"var(--font-d)","font-size":"16px",color:"var(--ink)"}},"رقم الفاتورة",-1)),r("div",oa,l(n(z).bookRef||"—"),1),r("div",ia,[r("img",{src:E.value,alt:"QR تفاصيل الحجز",loading:"lazy"},null,8,sa)]),r("a",{class:"receipt-link",href:B.value,target:"_blank",rel:"noopener"},"فتح تفاصيل الحجز",8,la),o[11]||(o[11]=r("small",null,"امسح الرمز بالكاميرا لعرض تفاصيل الحجز",-1))])]),r("div",da,[r("button",{class:"btn btn-gold",onClick:o[0]||(o[0]=_=>x("home"))},[...o[12]||(o[12]=[r("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[r("path",{d:"M3 9l9-6 9 6v11a1 1 0 01-1 1H4a1 1 0 01-1-1z"})],-1),C(" العودة إلى الرئيسية",-1)])]),r("button",{class:"btn btn-line",onClick:o[1]||(o[1]=_=>x("calendar"))},[...o[13]||(o[13]=[r("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8"},[r("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2"}),r("path",{d:"M16 2v4M8 2v4M3 10h18M12 14v4M10 16h4"})],-1),C(" إضافة للتقويم",-1)])]),r("button",{class:"btn btn-line",onClick:o[2]||(o[2]=_=>x("share"))},[...o[14]||(o[14]=[mr('<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><path d="M8.6 13.5l6.8 4M15.4 6.5l-6.8 4"></path></svg> مشاركة الحجز',2)])])]),r("div",pa,[(t(),s(D,null,W($,(_,G)=>r("div",{key:G,class:"trust"},[r("span",ca,[(t(),s("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.7",innerHTML:_[2]},null,8,ga))]),r("b",null,l(_[0]),1),r("small",null,l(_[1]),1)])),64))])])}}},ma={key:0,class:"card"},ha={key:0,class:"br-img"},ba=["src","alt"],fa={key:1,class:"sum-row"},va={class:"v"},ya={key:2,class:"sum-row"},wa={class:"v"},ka={class:"sum-row"},_a={class:"v"},za={class:"sum-row"},$a={class:"v"},Ma={key:3,class:"sum-row"},Ca={class:"v"},Fa={class:"sum-svcs"},Sa={class:"nm"},Ba={class:"pr"},La=["onClick"],Ea={class:"sum-price"},Aa={class:"sp-row"},Ta={class:"sp-row"},Da={class:"sp-total"},ja={class:"v"},Ia={class:"sum-note"},Ha={width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8",style:{flex:"none"}},Na={__name:"BookingSummary",setup(rr){const{state:e,selSvcs:z,totalDur:v,priceParts:S,toggleSvc:L}=sr(),{current:M}=hr(),x=Z(!1),P=m(()=>e.services.length>0);pr(P,V=>{V?Qr(()=>requestAnimationFrame(()=>{x.value=!0})):x.value=!1},{immediate:!0});const j=m(()=>S.value),A=m(()=>e.date?jr(e.date):"");return(V,y)=>(t(),s("div",{id:"summary",class:I({show:x.value})},[P.value?(t(),s("div",ma,[y[13]||(y[13]=r("h3",null,[r("svg",{width:"17",height:"17",viewBox:"0 0 24 24",fill:"none",stroke:"var(--gold-deep)","stroke-width":"1.8"},[r("path",{d:"M9 11l3 3L22 4"}),r("path",{d:"M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"})]),C(" ملخص الحجز")],-1)),n(M)?(t(),s("div",ha,[n(M).image?(t(),s("img",{key:0,src:n(M).image,alt:n(M).name},null,8,ba)):H("",!0)])):H("",!0),n(M)?(t(),s("div",fa,[y[0]||(y[0]=r("span",{class:"k"},"📍 الفرع",-1)),r("span",va,l(n(M).name),1)])):H("",!0),n(e).date?(t(),s("div",ya,[y[1]||(y[1]=r("span",{class:"k"},"📅 التاريخ",-1)),r("span",wa,l(A.value),1)])):H("",!0),r("div",ka,[y[2]||(y[2]=r("span",{class:"k"},"⏱️ المدة الإجمالية",-1)),r("span",_a,l(n(ur)(n(v))),1)]),r("div",za,[y[3]||(y[3]=r("span",{class:"k"},"✂️ عدد الخدمات",-1)),r("span",$a,l(n(z).length)+" "+l(n(z).length>2?"خدمات":"خدمة"),1)]),n(e).mode?(t(),s("div",Ma,[y[4]||(y[4]=r("span",{class:"k"},"👤 الموظفون",-1)),r("span",Ca,l(n(e).mode==="auto"?"اختيار تلقائي ذكي":"اختيار يدوي"),1)])):H("",!0),r("div",Fa,[(t(!0),s(D,null,W(n(z),B=>(t(),s("div",{key:B.id,class:"sum-svc"},[y[6]||(y[6]=r("i",{style:{background:"var(--gold)"}},null,-1)),r("span",Sa,l(B.name),1),r("span",Ba,l(n(O)(B.price))+" ر.س",1),r("button",{class:"rm","aria-label":"حذف",onClick:E=>n(L)(B)},[...y[5]||(y[5]=[r("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[r("path",{d:"M18 6L6 18M6 6l12 12"})],-1)])],8,La)]))),128))]),r("div",Ea,[r("div",Aa,[y[7]||(y[7]=r("span",null,"المجموع الفرعي",-1)),r("span",null,l(n(O)(j.value.sub))+" ر.س",1)]),r("div",Ta,[y[8]||(y[8]=r("span",null,"ضريبة القيمة المضافة (15%)",-1)),r("span",null,"+"+l(n(O)(j.value.vat))+" ر.س",1)]),r("div",Da,[y[10]||(y[10]=r("span",{class:"k"},"المبلغ الإجمالي",-1)),r("span",ja,[C(l(n(O)(j.value.total))+" ",1),y[9]||(y[9]=r("small",null,"ر.س",-1))])])]),r("div",Ia,[(t(),s("svg",Ha,[...y[11]||(y[11]=[r("path",{d:"M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"},null,-1)])])),y[12]||(y[12]=C(" بياناتك محمية — يمكنك تعديل أو إلغاء الحجز قبل 6 ساعات من الموعد",-1))])])):H("",!0)],2))}},Pa={class:"shell"},Va={class:"wrap"},Ya={class:"panel",id:"panel"},Ra={key:0,class:"success-wrap receipt-wrap"},qa={class:"suc-grid receipt-grid"},Oa={class:"card suc-details"},Ga={class:"sd-row"},Ua={class:"v receipt-code"},Wa={class:"sd-row"},Ka={class:"v"},Xa={class:"sd-row"},Ja={class:"v"},Qa={class:"sd-row"},Za={class:"v"},ro={class:"sd-row"},eo={class:"v"},no={class:"sd-row"},to={class:"card suc-details receipt-services"},ao={class:"footbar",id:"footbar"},oo={class:"wrap in"},io={class:"fb-mid",id:"fbMid"},so={key:0,class:"tot"},lo=["disabled"],po="color:var(--gold-deep);font-family:var(--font-d);font-size:17px",yo={__name:"BookingView",setup(rr){const e=Z(null),z=Zr(),{current:v,loadServiceLocations:S}=hr(),{requireAuth:L,user:M}=Yr();S();const{state:x,selSvcs:P,priceParts:j,canProceed:A,nextLabel:V,reset:y,payableTotal:B,walletDiscount:E,loyaltyPointsUsed:T}=sr();re(pe,"booking"),ee(e);const $=Z(!1),h=Z(""),o=Z(!1);function p(R){h.value=R,o.value=!0,clearTimeout(p._h),p._h=setTimeout(()=>{o.value=!1},2600)}const _=m(()=>x.services.length>0),G=m(()=>x.step===4?B.value:j.value.total);function Y(R){if(!R)return null;try{const k=String(R).replace(/-/g,"+").replace(/_/g,"/"),X=k.padEnd(k.length+(4-k.length%4)%4,"="),nr=JSON.parse(decodeURIComponent(escape(atob(X))));return nr&&typeof nr=="object"?nr:null}catch{return null}}const F=m(()=>Y(z.query.receipt)),K=m(()=>!!F.value),er=m(()=>{var R;return Array.isArray((R=F.value)==null?void 0:R.s)?F.value.s:[]}),g=m(()=>!K.value&&!x.done&&_.value&&x.step>=1),c=m(()=>g.value?"minmax(0,1fr) minmax(285px,315px)":"1fr");function u(){x.step>0&&(x.step--,scrollTo({top:0,behavior:"smooth"}))}function b(){if(A.value){if(x.step===4){L(w);return}x.step++,scrollTo({top:0,behavior:"smooth"})}}function f(R){return`${R.getFullYear()}-${String(R.getMonth()+1).padStart(2,"0")}-${String(R.getDate()).padStart(2,"0")}`}async function w(){var R,k,X,nr,$r,xr,Mr;$.value=!0;try{const br=[(R=M.value)==null?void 0:R.first_name,(k=M.value)==null?void 0:k.last_name].filter(Boolean).join(" ");x.cust.name=x.cust.name||br||((X=M.value)==null?void 0:X.username)||"",x.cust.phone=x.cust.phone||((nr=M.value)==null?void 0:nr.mobile)||"",x.cust.mail=x.cust.mail||(($r=M.value)==null?void 0:$r.email)||"";const fr=(xr=v.value)!=null&&xr.home?0:Number((Mr=v.value)==null?void 0:Mr.id),Cr=P.value.map(d=>{var N;return{subServices:[{id:d.id,date:f(x.date),time:x.time[d.id],duration:d.dur,staffId:(N=x.emp[d.id])==null?void 0:N.id}]}});await oe({branch:fr,services:Cr,customerName:x.cust.name,mobileNo:x.cust.phone});const Er=x.rewards,Fr=Number(E.value.toFixed(2)),vr=T.value,lr=Fr>0,yr=vr>0,Ar=Er.couponApplied||"",i=lr||yr?"card":x.pay||"card",a=await ie(i,{wallet:lr,walletAmount:Fr,loyalty:yr,loyaltyPoints:vr,couponCode:Ar});if(a.payment_url){window.location.href=a.payment_url;return}x.bookRef=a.invoice_id||null,x.done=!0,scrollTo({top:0,behavior:"smooth"})}catch(br){p(br.message||"تعذّر إتمام الحجز، حاول مرة أخرى")}finally{$.value=!1}}function U(){y(),location.href="/"}return(R,k)=>(Rr("RouterLink"),t(),s("div",{ref_key:"root",ref:e},[r("div",Pa,[K.value?H("",!0):(t(),gr(ve,{key:0})),r("div",Va,[r("div",{class:"stage",id:"stage",style:_r(`grid-template-columns:${c.value}`)},[r("main",Ya,[K.value?(t(),s("div",Ra,[k[10]||(k[10]=r("div",{class:"suc-ic"},[r("svg",{width:"44",height:"44",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.2"},[r("path",{d:"M20 6L9 17l-5-5"})])],-1)),k[11]||(k[11]=r("h1",null,"تفاصيل الحجز",-1)),k[12]||(k[12]=r("p",{class:"sub"},"تم فتح تفاصيل الحجز من رمز QR",-1)),r("div",qa,[r("div",Oa,[k[8]||(k[8]=r("h4",null,"بيانات الحجز",-1)),r("div",Ga,[k[2]||(k[2]=r("span",{class:"k"},"رقم الفاتورة",-1)),r("span",Ua,l(F.value.r||"—"),1)]),r("div",Wa,[k[3]||(k[3]=r("span",{class:"k"},"الفرع",-1)),r("span",Ka,l(F.value.b||"—"),1)]),r("div",Xa,[k[4]||(k[4]=r("span",{class:"k"},"التاريخ",-1)),r("span",Ja,l(F.value.d||"—"),1)]),r("div",Qa,[k[5]||(k[5]=r("span",{class:"k"},"مدة الجلسة",-1)),r("span",Za,l(F.value.u||"—"),1)]),r("div",ro,[k[6]||(k[6]=r("span",{class:"k"},"الفريق",-1)),r("span",eo,l(F.value.e||"—"),1)]),r("div",no,[k[7]||(k[7]=r("span",{class:"k"},"المبلغ",-1)),r("span",{class:"v",style:po},l(n(O)(Number(F.value.p)||0))+" ر.س",1)])]),r("div",to,[k[9]||(k[9]=r("h4",null,"الخدمات",-1)),(t(!0),s(D,null,W(er.value,(X,nr)=>(t(),s("div",{key:nr,class:"receipt-service"},[r("b",null,l(X[0]),1),r("small",null,l(X[1]||"—")+" · "+l(X[2]||F.value.e||"—"),1),r("span",null,l(n(O)(Number(X[3])||0))+" ر.س",1)]))),128))])])])):n(x).done?(t(),gr(xa,{key:1,onHome:U,onCalendar:k[0]||(k[0]=X=>p("تمت إضافة الموعد إلى التقويم")),onShare:k[1]||(k[1]=X=>p("تم نسخ رابط الحجز للمشاركة"))})):n(x).step===0?(t(),gr(qe,{key:2})):n(x).step===1?(t(),gr(an,{key:3})):n(x).step===2?(t(),gr(In,{key:4})):n(x).step===3?(t(),gr(tt,{key:5})):(t(),gr(Lt,{key:6}))]),Sr(r("aside",{class:I(["summary booking-summary-compact",{show:g.value,"booking-summary-time":n(x).step===2}])},[kr(Na)],2),[[Tr,g.value]])],4)])]),H("",!0),Sr(r("div",ao,[r("div",oo,[r("button",{class:"btn btn-back",id:"btnBack",style:_r({visibility:n(x).step===0?"hidden":"visible"}),onClick:u},[...k[29]||(k[29]=[r("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[r("path",{d:"M5 12h14M13 6l6 6-6 6"})],-1),C(" السابق ",-1)])],4),r("div",io,[k[31]||(k[31]=r("span",null,"🔒 بياناتك محمية وآمنة",-1)),_.value?(t(),s("span",so,[k[30]||(k[30]=C("المبلغ الإجمالي ",-1)),r("b",null,l(n(O)(Math.round(G.value)))+" ر.س",1)])):H("",!0)]),r("button",{class:I(["btn",n(x).step===4?"btn-pay":"btn-gold"]),id:"btnNext",disabled:!n(A),onClick:b},[C(l(n(V))+" ",1),k[32]||(k[32]=r("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.2"},[r("path",{d:"M19 12H5M11 18l-6-6 6-6"})],-1))],10,lo)])],512),[[Tr,!n(x).done&&!K.value]]),r("div",{class:I(["pay-loading",{on:$.value}]),id:"payLoading"},[...k[33]||(k[33]=[r("div",{class:"pl-box"},[r("div",{class:"pl-ring"}),r("b",null,"جارٍ معالجة الدفع بأمان…"),r("small",null,"لا تغلق الصفحة، سيتم تأكيد حجزك خلال لحظات")],-1)])],2),r("div",{class:I(["toast",{on:o.value}]),id:"toast"},l(h.value),3)],512))}};export{yo as default};
