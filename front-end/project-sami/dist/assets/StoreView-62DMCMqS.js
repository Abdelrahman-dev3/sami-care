...
`,ee=[{id:"sp1",badge:"عرض محدود",title:"اشترِ 2 واحصل على الثالث مجانًا",text:"على مجموعة مختارة من منتجات العناية بالشعر واللحية",cta:"تسوق العرض"}],fe=[{id:"mada",n:"مدى",d:"ادفع باستخدام بطاقات مدى",logo:"مدى mada",form:!0},{id:"apple",n:"Apple Pay",d:"دفع سريع وآمن عبر أجهزتك",logo:" Pay",form:!1},{id:"card",n:"فيزا / ماستركارد",d:"بطاقات ائتمانية أو مسبقة الدفع",logo:"VISA ●●",form:!0},{id:"wallet",n:"المحفظة",d:"ادفع من رصيدك في سامي",logo:"👛",form:!1},{id:"cod",n:"الدفع عند الاستلام",d:"ادفع عند استلام طلبك",logo:"💵",form:!1}],me={class:"pimg"},he=["data-fav"],ve=["src","alt"],ue=["width","height","viewBox","innerHTML"],ke={class:"pbody"},ye={class:"prow"},we=["data-add"],ze=["aria-label"],Fe=["aria-label"],$e={key:0,width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},Ce={key:1,width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.4"},Be={class:"qstep__val"},_e={class:"pr"},ne={__name:"ProductCard",props:{p:{type:Object,required:!0},index:{type:Number,default:0},view:{type:String,default:"grid"},fav:{type:Boolean,default:!1},qty:{type:Number,default:0}},emits:["toggle-fav","add","set-qty"],setup(m){const M=m,h=P(()=>`animation-delay:${Math.min(M.index*.05,.4)}s`),C=P(()=>M.view==="list"?96:118),F=P(()=>L(M.p.shape,C.value));return(v,p)=>(t(),s("article",{class:"pcard",style:J(h.value)},[e("div",me,[p[5]||(p[5]=e("div",{class:"shelf"},null,-1)),m.p.badge?(t(),s("span",{key:0,class:A(["badge-tag",{new:m.p.new}])},i(m.p.badge),3)):O("",!0),e("button",{class:A(["fav2",{on:m.fav}]),"data-fav":m.p.id,"aria-label":"مفضلة",onClick:p[0]||(p[0]=c=>v.$emit("toggle-fav",m.p.id))},[...p[4]||(p[4]=[e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8"},[e("path",{d:"M12 21s-7-4.4-9.3-8.5C.8 9 2.6 5.5 6 5.5c2 0 3.4 1.1 4 2.3.6-1.2 2-2.3 4-2.3 3.4 0 5.2 3.5 3.3 7-2.3 4.1-9.3 8.5-9.3 8.5z"})],-1)])],10,he),m.p.image?(t(),s("img",{key:1,class:"prod-photo",src:m.p.image,alt:m.p.n,loading:"lazy"},null,8,ve)):(t(),s("svg",{key:2,class:"prod",width:C.value,height:C.value,viewBox:F.value.viewBox,innerHTML:F.value.inner},null,8,ue))]),e("div",ke,[e("b",null,i(m.p.n),1),e("small",null,i(m.p.d),1),e("div",ye,[m.qty?(t(),s("div",{key:1,class:"qstep",role:"group","aria-label":`كمية ${m.p.n}`},[e("button",{class:"qstep__btn","aria-label":m.qty===1?"إزالة من السلة":"إنقاص الكمية",onClick:p[2]||(p[2]=c=>v.$emit("set-qty",m.p.id,m.qty-1))},[m.qty===1?(t(),s("svg",$e,[...p[7]||(p[7]=[e("path",{d:"M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6"},null,-1)])])):(t(),s("svg",Ce,[...p[8]||(p[8]=[e("path",{d:"M5 12h14"},null,-1)])]))],8,Fe),e("span",Be,i(m.qty),1),e("button",{class:"qstep__btn","aria-label":"زيادة الكمية",onClick:p[3]||(p[3]=c=>v.$emit("set-qty",m.p.id,m.qty+1))},[...p[9]||(p[9]=[e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.4"},[e("path",{d:"M12 5v14M5 12h14"})],-1)])])],8,ze)):(t(),s("button",{key:0,class:"addbtn","data-add":m.p.id,onClick:p[1]||(p[1]=c=>v.$emit("add",m.p.id,c))},[...p[6]||(p[6]=[e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.8"},[e("path",{d:"M6 7h12l1.5 14h-15zM8 7a4 4 0 018 0"})],-1),g(" إضافة للسلة ",-1)])],8,we)),e("span",_e,[g(i(r(D)(m.p.pr))+" ",1),p[10]||(p[10]=e("small",null,"ر.س",-1))])])])],4))}},Me={class:"st-hero",id:"stHero"},je={class:"in"},Ee={class:"hero-ctas"},Ae={class:"hero-scene",id:"heroScene"},Le={class:"hp-card hp-c1","data-depth":"16"},Se={class:"fb"},qe=["viewBox","innerHTML"],Te={class:"hp-card hp-c2","data-depth":"26"},De={class:"fb"},Ye=["viewBox","innerHTML"],Pe={class:"hp-card hp-c3","data-depth":"24"},He={class:"fb"},Ie=["viewBox","innerHTML"],Oe={class:"hp-badge hp-b1","data-depth":"34"},Ve={class:"bi2"},Re={class:"hp-badge hp-b2","data-depth":"30"},Ne={class:"bi2"},Qe={class:"st-strip"},Xe={class:"si"},Ge={class:"sec-line"},Ue={class:"cats"},Je=["data-cat","onClick"],Ke={class:"ic-mini"},We={class:"ill",style:{background:"radial-gradient(70px 40px at 50% 85%,rgba(198,161,91,.28),transparent 65%),linear-gradient(150deg,#2A2318,#0F0C07)","border-radius":"11px"}},Ze=["viewBox","innerHTML"],en={key:0,class:"store-promos"},nn={class:"store-promo__badge"},rn={class:"store-promo__txt"},on=["data-promo"],tn={class:"sec-line"},an={class:"best-wrap"},sn={class:"caro-btn r","data-caro":"1"},ln={class:"caro-btn l","data-caro":"-1"},pn={class:"best-caro",id:"bestCaro"},dn={class:"grid-tools"},gn={class:"gt-filter"},cn={class:"gt-count"},xn={class:"view-tg"},bn={class:"gt-sort"},fn={key:1,class:"show-more"},mn={class:"perks",style:{"grid-template-columns":"repeat(4,1fr)","margin-top":"26px"}},hn={class:"pi"},vn={__name:"StoreCatalog",emits:["scroll-to-grid","add"],setup(m,{emit:M}){const{state:h,isFav:C,toggleFav:F,visibleProducts:v,setQty:p,products:c,categories:u}=K(),B=_=>h.cart[_]||0,l=P(()=>u.value.length?u.value.slice(1).concat(u.value[0]):[]),y=P(()=>c.value.filter(n=>h.cat==="all"||n.cat===h.cat).length),w=P(()=>c.value.filter(_=>_.best)),S=P(()=>Array.from({length:7},(_,n)=>({ch:n%3?"✦":"❖",style:`top:${10+n*13%75}%;${n%2?"right":"left"}:${4+n*9%42}%;animation-delay:-${n*.7}s`}))),I=_=>{const n=u.value.find(a=>a.id===_);return L(n?n.shape:"kit",52)},j=[["جودة مختارة بعناية","منتجات أصلية 100%",k.star],["تغليف فاخر","اهتمام بكل تفاصيل الطلب",k.box],["استلام من الفرع","جاهزة للاستلام من أقرب فرع",k.home],["إهداء سهل","أرسل المنتج أو الباقة كهدية",k.chat]],o=M;function q(_){h.cat=_,h.showAll=!1}function x(){h.showAll=!h.showAll}function V(_){h.view=_}return(_,n)=>(t(),s($,null,[e("section",Me,[n[26]||(n[26]=G('<svg class="veins" viewBox="0 0 800 430" preserveAspectRatio="none" fill="none"><path d="M-20 340 C160 300 240 380 420 330 S 700 250 830 300" stroke="rgba(198,161,91,.14)" stroke-width="1.2"></path><path d="M-20 120 C120 160 300 60 460 110 S 720 190 830 140" stroke="rgba(198,161,91,.1)" stroke-width="1"></path><path d="M100 430 C180 340 320 420 430 350" stroke="rgba(233,207,142,.08)" stroke-width="1"></path></svg><div class="hero-frame"></div>',2)),(t(!0),s($,null,Y(S.value,(a,E)=>(t(),s("span",{key:E,class:"hp",style:J(a.style)},i(a.ch),5))),128)),e("div",je,[n[12]||(n[12]=e("span",{class:"eyebrow2"},[e("i"),g(" منتجات مختارة بعناية — جودة الصالون في منزلك")],-1)),n[13]||(n[13]=e("h1",null,[g("لتجربة يومية"),e("br"),e("span",{class:"g"},"استثنائيــــة")],-1)),n[14]||(n[14]=e("p",null,"منتجات فاخرة بجودة عالية لرجل يهتم بأدق التفاصيل — من العناية بالشعر واللحية إلى العطور الفاخرة.",-1)),e("div",Ee,[e("button",{class:"btn btn-gold",id:"heroCta",onClick:n[0]||(n[0]=a=>o("scroll-to-grid"))},[n[11]||(n[11]=g("اكتشف المجموعة ",-1)),d(f,{inner:r(k).arrowL,size:15},null,8,["inner"])]),e("button",{class:"btn btn-outline-l",id:"heroBest",onClick:n[1]||(n[1]=a=>o("scroll-to-grid"))},"الأكثر مبيعًا")]),n[15]||(n[15]=e("div",{class:"hero-stats"},[e("div",{class:"hstat"},[e("b",null,"+30"),e("small",null,"منتج عناية فاخر")]),e("div",{class:"hstat"},[e("b",null,"100%"),e("small",null,"منتجات أصلية")]),e("div",{class:"hstat"},[e("b",null,"4.9 ★"),e("small",null,"تقييم عملائنا")])],-1))]),e("div",Ae,[n[24]||(n[24]=e("div",{class:"glow"},null,-1)),n[25]||(n[25]=e("div",{class:"ring2"},null,-1)),e("div",Le,[n[16]||(n[16]=e("img",{src:"https://sami-care.sa//storage/uploads/406/uGGoLhrbcMofuyS2kedJ44ejvBqYnz1M0mA0zTMP.jpg",alt:"زيت اللحية الذهبي",loading:"eager",onerror:"this.style.display='none';this.nextElementSibling.style.display='grid'"},null,-1)),e("div",Se,[(t(),s("svg",{class:"prod",width:"90",height:"90",viewBox:r(L)("dropper",90).viewBox,innerHTML:r(L)("dropper",90).inner},null,8,qe))]),n[17]||(n[17]=e("span",{class:"tag2"},"زيت اللحية الذهبي",-1))]),e("div",Te,[n[18]||(n[18]=e("img",{src:"https://sami-care.sa//storage/uploads/403/HyxbPuOgHBgbg0pgpMZr9bcFv2OryQtxjRMLnhxb.jpg",alt:"كريم الترطيب",onerror:"this.style.display='none';this.nextElementSibling.style.display='grid'"},null,-1)),e("div",De,[(t(),s("svg",{class:"prod",width:"70",height:"70",viewBox:r(L)("jar",70).viewBox,innerHTML:r(L)("jar",70).inner},null,8,Ye))]),n[19]||(n[19]=e("span",{class:"tag2"},"كريم الترطيب",-1))]),e("div",Pe,[n[20]||(n[20]=e("img",{src:"https://sami-care.sa//storage/uploads/405/L2sxjQjZgTztP0swgRTlXV0jVjCLuS5GJyypCJmT.jpg",alt:"غسول البشرة",onerror:"this.style.display='none';this.nextElementSibling.style.display='grid'"},null,-1)),e("div",He,[(t(),s("svg",{class:"prod",width:"70",height:"70",viewBox:r(L)("pump",70).viewBox,innerHTML:r(L)("pump",70).inner},null,8,Ie))]),n[21]||(n[21]=e("span",{class:"tag2"},"غسول البشرة",-1))]),e("div",Oe,[e("span",Ve,[d(f,{inner:r(k).star,size:16},null,8,["inner"])]),n[22]||(n[22]=e("span",null,[e("b",null,"منتجات أصلية 100%"),e("small",null,"مختارة من عناية سامي")],-1))]),e("div",Re,[e("span",Ne,[d(f,{inner:r(k).box,size:16},null,8,["inner"])]),n[23]||(n[23]=e("span",null,[e("b",null,"تغليف فاخر"),e("small",null,"اهتمام بكل تفاصيل الطلب")],-1))])])]),e("div",Qe,[e("span",Xe,[d(f,{inner:r(k).bag,size:19},null,8,["inner"])]),n[28]||(n[28]=e("p",null,"منتجات مختارة خصيصًا لتكمل تجربة عناية سامي داخل المنزل",-1)),e("button",{class:"btn btn-line",id:"stripCta",style:{padding:"11px 24px","font-size":"12.5px"},onClick:n[2]||(n[2]=a=>o("scroll-to-grid"))},[n[27]||(n[27]=g("تسوق المجموعة الكاملة ",-1)),d(f,{inner:r(k).arrowL,size:13},null,8,["inner"])])]),e("div",Ge,[n[30]||(n[30]=e("h2",null,"تسوق حسب الفئة",-1)),e("a",{"data-cat":"all",onClick:n[3]||(n[3]=a=>q("all"))},[d(f,{inner:r(k).arrowL,size:13},null,8,["inner"]),n[29]||(n[29]=g(" عرض جميع الفئات",-1))])]),e("div",Ue,[(t(!0),s($,null,Y(l.value,a=>(t(),s("div",{key:a.id,class:A(["catc",{on:r(h).cat===a.id}]),"data-cat":a.id,onClick:E=>q(a.id)},[e("span",Ke,[d(f,{inner:r(k).star,size:12},null,8,["inner"])]),e("div",We,[(t(),s("svg",{class:"prod",width:"52",height:"52",viewBox:I(a.id).viewBox,innerHTML:I(a.id).inner},null,8,Ze))]),e("b",null,i(a.n),1)],10,Je))),128))]),r(ee).length?(t(),s("div",en,[(t(!0),s($,null,Y(r(ee),a=>(t(),s("div",{key:a.id,class:"store-promo"},[e("span",nn,i(a.badge),1),e("div",rn,[e("h3",null,i(a.title),1),e("p",null,i(a.text),1)]),e("button",{class:"btn btn-gold","data-promo":a.id,onClick:n[4]||(n[4]=E=>o("scroll-to-grid"))},[g(i(a.cta)+" ",1),d(f,{inner:r(k).arrowL,size:13},null,8,["inner"])],8,on)]))),128))])):O("",!0),e("div",tn,[n[32]||(n[32]=e("h2",null,"الأكثر مبيعًا",-1)),e("a",{"data-showall":"1",onClick:n[5]||(n[5]=a=>r(h).showAll=!0)},[d(f,{inner:r(k).arrowL,size:13},null,8,["inner"]),n[31]||(n[31]=g(" عرض جميع المنتجات",-1))])]),e("div",an,[e("button",sn,[d(f,{inner:r(k).chevR,size:15},null,8,["inner"])]),e("button",ln,[d(f,{inner:r(k).chevL,size:15},null,8,["inner"])]),e("div",pn,[(t(!0),s($,null,Y(w.value,(a,E)=>(t(),Q(ne,{key:a.id,p:a,index:E,view:r(h).view,fav:r(C)(a.id),qty:B(a.id),onToggleFav:r(F),onAdd:n[6]||(n[6]=(R,N)=>o("add",R,N)),onSetQty:r(p)},null,8,["p","index","view","fav","qty","onToggleFav","onSetQty"]))),128))])]),n[37]||(n[37]=e("div",{class:"sec-line"},[e("h2",null,"منتجات عناية سامي")],-1)),e("div",dn,[e("button",gn,[d(f,{inner:r(k).filter,size:15},null,8,["inner"]),n[33]||(n[33]=g(" تصفية المنتجات",-1))]),e("span",cn,"عرض 1 - "+i(r(v).length)+" من "+i(y.value)+" منتج",1),e("div",xn,[e("button",{class:A({on:r(h).view==="grid"}),"data-view":"grid","aria-label":"شبكة",onClick:n[7]||(n[7]=a=>V("grid"))},[d(f,{inner:r(k).grid,size:15},null,8,["inner"])],2),e("button",{class:A({on:r(h).view==="list"}),"data-view":"list","aria-label":"قائمة",onClick:n[8]||(n[8]=a=>V("list"))},[d(f,{inner:r(k).list,size:15},null,8,["inner"])],2)]),e("div",bn,[n[35]||(n[35]=g("ترتيب ",-1)),X(e("select",{id:"sortSel","onUpdate:modelValue":n[9]||(n[9]=a=>r(h).sort=a)},[...n[34]||(n[34]=[e("option",{value:"new"},"الأحدث",-1),e("option",{value:"best"},"الأكثر مبيعًا",-1),e("option",{value:"low"},"السعر: الأقل أولًا",-1),e("option",{value:"high"},"السعر: الأعلى أولًا",-1)])],512),[[re,r(h).sort]])])]),e("div",{class:A(["pgrid",{list:r(h).view==="list"}]),id:"pgrid"},[(t(!0),s($,null,Y(r(v),(a,E)=>(t(),Q(ne,{key:a.id,p:a,index:E,view:r(h).view,fav:r(C)(a.id),qty:B(a.id),onToggleFav:r(F),onAdd:n[10]||(n[10]=(R,N)=>o("add",R,N)),onSetQty:r(p)},null,8,["p","index","view","fav","qty","onToggleFav","onSetQty"]))),128))],2),y.value>8?(t(),s("div",fn,[e("button",{id:"moreBtn",onClick:x},[r(h).showAll?(t(),s($,{key:0},[n[36]||(n[36]=g("إخفاء المنتجات ",-1)),d(f,{inner:r(k).chevUp,size:14},null,8,["inner"])],64)):(t(),s($,{key:1},[g("عرض جميع المنتجات ("+i(y.value)+") ",1),d(f,{inner:r(k).chevDown,size:14},null,8,["inner"])],64))])])):O("",!0),e("div",mn,[(t(),s($,null,Y(j,(a,E)=>e("div",{key:E,class:"perk"},[e("span",hn,[d(f,{inner:a[2],size:17},null,8,["inner"])]),e("b",null,i(a[0]),1),e("small",null,i(a[1]),1)])),64))])],64))}},un={class:"g-stepper",style:{"padding-bottom":"0"}},kn={style:{display:"flex","align-items":"center",gap:"12px","justify-content":"center"}},yn={class:"g-stage",style:{"padding-top":"6px"}},wn={class:"view on"},zn={class:"card",style:{padding:"22px","margin-bottom":"14px"}},Fn={class:"fld",style:{margin:"0"}},$n={class:"card",style:{padding:"22px","margin-bottom":"14px"}},Cn={class:"two"},Bn={class:"fld",style:{margin:"0"}},_n={class:"fld",style:{margin:"0"}},Mn={class:"card",style:{padding:"22px"}},jn=["data-ckpay"],En=["onClick"],An={class:"lg"},Ln={class:"tt"},Sn={key:0,style:{color:"#b42318","font-size":"12.5px",margin:"12px 0 0"}},qn={class:"inline-actions"},Tn=["disabled"],Dn={class:"gsum"},Yn={class:"card",style:{padding:"20px"}},Pn={class:"thumb"},Hn=["viewBox","innerHTML"],In={class:"p"},On={style:{"margin-top":"12px","padding-top":"12px","border-top":"1px dashed var(--line)"}},Vn={class:"gs-row",style:{border:"none",padding:"4px 0"}},Rn={class:"v"},Nn={class:"gs-row",style:{border:"none",padding:"4px 0"}},Qn={class:"v"},Xn={class:"gs-row",style:{border:"none",padding:"4px 0"}},Gn={class:"gs-total"},Un={class:"v"},Jn={class:"gs-note"},Kn={__name:"StoreCheckout",emits:["back","placed"],setup(m,{emit:M}){const h=M,{state:C,cartItems:F,ckParts:v,ckCan:p,placeOrder:c}=K(),u=C.ck,B={arrowR:'<path d="M5 12h14M13 6l6 6-6 6"/>',lock:'<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/>',check:'<path d="M20 6L9 17l-5-5"/>'},l=j=>L(j,34),y=["cod","wallet"],w=T("");function S(j){y.includes(j.id)&&(u.pay=j.id)}async function I(){if(p.value){w.value="";try{await c(),h("placed")}catch(j){w.value=j.message||"تعذّر إتمام الطلب، حاول مرة أخرى"}}}return(j,o)=>{const q=te("RouterLink");return t(),s($,null,[e("div",un,[e("div",kn,[e("button",{class:"btn btn-prev",id:"backStore",style:{padding:"10px 20px","font-size":"12.5px"},onClick:o[0]||(o[0]=x=>h("back"))},[d(f,{inner:B.arrowR,size:14},null,8,["inner"]),o[7]||(o[7]=g(" العودة للمتجر",-1))])])]),o[26]||(o[26]=e("div",{class:"g-head",style:{"margin-top":"14px"}},[e("h1",null,"إتمام الطلب 🛍️"),e("p",null,"خطوة أخيرة وتصلك منتجاتك المختارة بعناية")],-1)),e("div",yn,[e("main",wn,[e("div",zn,[o[9]||(o[9]=e("h4",{style:{"font-family":"var(--font-d)","font-size":"16px",color:"var(--ink)","margin-bottom":"14px"}},"1️⃣ عنوان التوصيل",-1)),e("div",Fn,[o[8]||(o[8]=e("label",null,"العنوان",-1)),X(e("input",{id:"ckAddr",placeholder:"الحي، الشارع، رقم المبنى...","onUpdate:modelValue":o[1]||(o[1]=x=>r(u).addr=x)},null,512),[[U,r(u).addr]])])]),e("div",$n,[o[12]||(o[12]=e("h4",{style:{"font-family":"var(--font-d)","font-size":"16px",color:"var(--ink)","margin-bottom":"14px"}},"2️⃣ بيانات العميل",-1)),e("div",Cn,[e("div",Bn,[o[10]||(o[10]=e("label",null,"الاسم الكامل",-1)),X(e("input",{id:"ckName","onUpdate:modelValue":o[2]||(o[2]=x=>r(u).name=x)},null,512),[[U,r(u).name]])]),e("div",_n,[o[11]||(o[11]=e("label",null,"رقم الجوال",-1)),X(e("input",{id:"ckPhone",dir:"ltr","onUpdate:modelValue":o[3]||(o[3]=x=>r(u).phone=x)},null,512),[[U,r(u).phone]])])])]),e("div",Mn,[o[17]||(o[17]=e("h4",{style:{"font-family":"var(--font-d)","font-size":"16px",color:"var(--ink)","margin-bottom":"14px"}},"3️⃣ طريقة الدفع",-1)),(t(!0),s($,null,Y(r(fe),x=>(t(),s("div",{key:x.id,class:A(["acc-pm",{sel:r(u).pay===x.id,disabled:!y.includes(x.id)}]),"data-ckpay":x.id},[e("div",{class:"head",onClick:V=>S(x)},[e("span",An,i(x.logo),1),e("span",Ln,[e("b",null,i(x.n),1),e("small",null,i(y.includes(x.id)?x.d:"قريبًا"),1)]),o[13]||(o[13]=e("span",{class:"rad"},[e("i")],-1))],8,En)],10,jn))),128)),w.value?(t(),s("p",Sn,i(w.value),1)):O("",!0),e("span",{class:A(["terms-chk",{on:r(u).terms}]),id:"ckTerms",onClick:o[5]||(o[5]=x=>r(u).terms=!r(u).terms)},[e("i",null,[d(f,{inner:B.check,size:11},null,8,["inner"])]),o[15]||(o[15]=g(" أوافق على ",-1)),d(q,{to:"/terms",onClick:o[4]||(o[4]=ie(()=>{},["stop"]))},{default:ae(()=>[...o[14]||(o[14]=[g("الشروط والأحكام وسياسة الاسترجاع",-1)])]),_:1})],2),e("div",qn,[e("button",{class:"btn btn-prev",id:"backStore2",onClick:o[6]||(o[6]=x=>h("back"))},[d(f,{inner:B.arrowR,size:15},null,8,["inner"]),o[16]||(o[16]=g(" الرجوع للمتجر",-1))]),e("button",{class:"btn btn-gold",id:"placeOrder",disabled:!r(p)||r(C).placing,onClick:I},[d(f,{inner:B.lock,size:15},null,8,["inner"]),g(" "+i(r(C).placing?"جارٍ إتمام الطلب...":`إتمام الطلب — ${r(D)(r(v).total)} ر.س`),1)],8,Tn)]),o[18]||(o[18]=e("div",{class:"after-pay",style:{"font-size":"11.5px",color:"var(--mute)","text-align":"center","margin-top":"12px"}},"🔒 جميع عمليات الدفع آمنة ومشفرة",-1))])]),e("aside",null,[e("div",Dn,[e("div",Yn,[o[25]||(o[25]=e("h3",{style:{"font-family":"var(--font-d)","font-size":"17px",color:"var(--ink)","margin-bottom":"14px",display:"flex",gap:"10px","align-items":"center"}},[g("ملخص الطلب"),e("span",{style:{flex:"1",height:"1px",background:"linear-gradient(-90deg,var(--gold),transparent)"}})],-1)),(t(!0),s($,null,Y(r(F),x=>(t(),s("div",{key:x.id,class:"sum-item"},[e("span",Pn,[(t(),s("svg",{class:"prod",width:"34",height:"34",viewBox:l(x.shape).viewBox,innerHTML:l(x.shape).inner},null,8,Hn))]),e("span",null,[e("b",null,i(x.n),1),e("small",null,"الكمية: "+i(x.qty),1)]),e("span",In,i(r(D)(x.pr*x.qty))+" ر.س",1)]))),128)),e("div",On,[e("div",Vn,[o[19]||(o[19]=e("span",{class:"k"},"المجموع الفرعي",-1)),e("span",Rn,i(r(D)(r(v).sub))+" ر.س",1)]),e("div",Nn,[o[20]||(o[20]=e("span",{class:"k"},"ضريبة القيمة المضافة (15%)",-1)),e("span",Qn,"+"+i(r(D)(r(v).vat))+" ر.س",1)]),e("div",Xn,[o[21]||(o[21]=e("span",{class:"k"},"رسوم التوصيل",-1)),e("span",{class:"v",style:J(r(v).ship?"":"color:var(--green)")},i(r(v).ship?"+"+r(D)(r(v).ship)+" ر.س":"مجانًا"),5)])]),e("div",Gn,[o[23]||(o[23]=e("span",{class:"k"},"الإجمالي",-1)),e("span",Un,[g(i(r(D)(r(v).total))+" ",1),o[22]||(o[22]=e("small",{style:{"font-size":"13px"}},"ر.س",-1))])]),e("div",Jn,[d(f,{inner:B.lock,size:14},null,8,["inner"]),o[24]||(o[24]=g(" الدفع آمن ومشفّر — بياناتك محمية بالكامل",-1))])])])])])],64)}}},Wn=oe(Kn,[["__scopeId","data-v-42738401"]]),Zn={class:"gsuccess",style:{"max-width":"860px","margin-inline":"auto"}},er={class:"gsuc-grid",style:{"grid-template-columns":"1.2fr 1fr"}},nr={class:"card gsuc-details"},rr={class:"gs-row"},or={class:"k"},tr={class:"v",dir:"ltr"},ar={class:"gs-row"},ir={class:"k"},sr={class:"v"},lr={class:"gs-row"},pr={class:"k"},dr={class:"v"},gr={class:"gs-row"},cr={class:"k"},xr={class:"v"},br={class:"gs-row"},fr={class:"k"},mr={class:"gs-row"},hr={class:"k"},vr={class:"v",style:{color:"var(--gold-deep)","font-family":"var(--font-d)","font-size":"17px"}},ur={class:"card gsuc-details"},kr={class:"thumb"},yr=["viewBox","innerHTML"],wr={class:"p"},zr={class:"gsuc-actions"},Fr={__name:"StoreSuccess",props:{order:{type:Object,required:!0}},emits:["back","track"],setup(m,{emit:M}){const h=m,C=M,F={qr:'<path d="M4 4h16v16H4z"/><path d="M9 9h2v2H9zM13 13h2v2h-2z"/>',user:'<path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/>',truck:'<path d="M1 3h15v13H1zM16 8h4l3 4v4h-7z"/><circle cx="6" cy="19" r="2"/><circle cx="19" cy="19" r="2"/>',card:'<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/>',check:'<path d="M20 6L9 17l-5-5"/>',lock:'<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/>',bag:'<path d="M6 7h12l1.5 14h-15zM8 7a4 4 0 018 0"/>'},v=P(()=>h.order),p=P(()=>h.order.parts),c=P(()=>v.value.items.reduce((B,l)=>B+l.q,0)),u=B=>L(B,34);return(B,l)=>(t(),s("div",Zn,[l[11]||(l[11]=G('<div class="gsuc-head" style="margin-top:20px;"><h1>تم تأكيد طلبك بنجاح!</h1><span class="ic"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"></path></svg></span></div><p class="sub">سيصلك طلبك خلال 24-48 ساعة على العنوان المحدد — وسنرسل لك إشعارًا فور تجهيزه ✨</p>',2)),e("div",er,[e("div",nr,[l[8]||(l[8]=e("h4",null,"تفاصيل الطلب",-1)),e("div",rr,[e("span",or,[d(f,{inner:F.qr,size:14},null,8,["inner"]),l[2]||(l[2]=g(" رقم الطلب",-1))]),e("span",tr,i(v.value.ref),1)]),e("div",ar,[e("span",ir,[d(f,{inner:F.user,size:14},null,8,["inner"]),l[3]||(l[3]=g(" العميل",-1))]),e("span",sr,i(v.value.name),1)]),e("div",lr,[e("span",pr,[d(f,{inner:F.truck,size:14},null,8,["inner"]),l[4]||(l[4]=g(" التوصيل",-1))]),e("span",dr,i(v.value.addr),1)]),e("div",gr,[e("span",cr,[d(f,{inner:F.card,size:14},null,8,["inner"]),l[5]||(l[5]=g(" طريقة الدفع",-1))]),e("span",xr,i(v.value.pay),1)]),e("div",br,[e("span",fr,[d(f,{inner:F.check,size:14},null,8,["inner"]),l[6]||(l[6]=g(" حالة الطلب",-1))]),l[7]||(l[7]=e("span",{class:"v"},[e("span",{class:"chip"},"قيد التجهيز")],-1))]),e("div",mr,[e("span",hr,[d(f,{inner:F.lock,size:14},null,8,["inner"]),g(" المبلغ "+i(v.value.pay==="الدفع عند الاستلام"?"المستحق":"المدفوع"),1)]),e("span",vr,i(r(D)(p.value.total))+" ر.س",1)])]),e("div",ur,[e("h4",null,"منتجاتك ("+i(c.value)+")",1),(t(!0),s($,null,Y(v.value.items,({p:y,q:w})=>(t(),s("div",{key:y.id,class:"sum-item"},[e("span",kr,[(t(),s("svg",{class:"prod",width:"34",height:"34",viewBox:u(y.shape).viewBox,innerHTML:u(y.shape).inner},null,8,yr))]),e("span",null,[e("b",null,i(y.n),1),e("small",null,"الكمية: "+i(w),1)]),e("span",wr,i(r(D)(y.pr*w))+" ر.س",1)]))),128))])]),e("div",zr,[e("button",{class:"btn btn-gold",id:"backStore3",onClick:l[0]||(l[0]=y=>C("back"))},[d(f,{inner:F.bag,size:15},null,8,["inner"]),l[9]||(l[9]=g(" متابعة التسوق",-1))]),e("button",{class:"btn btn-line",id:"trackOrder",onClick:l[1]||(l[1]=y=>C("track"))},[d(f,{inner:F.truck,size:15},null,8,["inner"]),l[10]||(l[10]=g(" تتبع الطلب",-1))])]),l[12]||(l[12]=e("div",{class:"thanks"},[e("i",null,"❦"),g(" شكرًا لثقتك بمنتجات عناية سامي "),e("i",null,"❦")],-1))]))}},$r={class:"shell"},Cr={class:"wrap",id:"storeApp"},Br={id:"contact",class:"site-footer"},_r={class:"footer-content container"},Mr={class:"sprod",id:"sheetProd"},jr={class:"thumb"},Er=["viewBox","innerHTML"],Ar={style:{flex:"1"}},Lr={class:"p"},Sr={class:"sacts"},qr={id:"toastTopMsg"},Yr={__name:"StoreView",setup(m){const M=T(null),h=T(null),C=T(null),{locations:F,loadServiceLocations:v}=se();v();const{requireAuth:p}=le(),{state:c,cartQty:u,pOf:B,placeOrder:l}=K();ce(be,"store"),xe(M);const y=T(!1),w=T(!1),S=T(null),I=T(!1),j=T(""),o=T(!1);function q(z){j.value=z,o.value=!0,clearTimeout(q._h),q._h=setTimeout(()=>{o.value=!1},2e3)}function x(){const z=h.value,b=C.value;!z||!b||(z.classList.remove("pop"),z.offsetWidth,z.classList.add("pop"),b.classList.remove("shake"),b.offsetWidth,b.classList.add("shake"),setTimeout(()=>z.classList.remove("pop"),350))}function V(z,b){c.cart[z]=(c.cart[z]||0)+1,ge(x),c.firstAdd?(c.firstAdd=!1,S.value=B(z),w.value=!0):q("تمت إضافة المنتج للسلة")}function _(){w.value=!1,y.value=!0}function n(){y.value=!1}function a(){n(),w.value=!1,c.page="checkout",c.ck.pay=null,c.ck.terms=!1,scrollTo({top:0,behavior:"smooth"})}function E(){c.page="store",scrollTo({top:0})}function R(){p(async()=>{I.value=!0;try{await l(),scrollTo({top:0,behavior:"smooth"})}catch(z){q(z.message||"تعذّر إتمام الطلب، حاول مرة أخرى")}finally{I.value=!1}})}function N(){const z=document.getElementById("pgrid");z&&z.scrollIntoView({behavior:"smooth",block:"start"})}Z(()=>[c.page,u.value],()=>{c.page==="checkout"&&!u.value&&(c.page="store")}),Z(()=>c.page,z=>{z!=="store"&&(w.value=!1)});const W=()=>S.value?L(S.value.shape,46):null;return(z,b)=>(t(),s("div",{ref_key:"root",ref:M},[e("div",$r,[e("div",Cr,[r(c).page==="store"?(t(),Q(vn,{key:0,onScrollToGrid:N,onAdd:V})):r(c).page==="checkout"?(t(),Q(Wn,{key:1,onBack:E,onPlaced:R})):r(c).page==="success"&&r(c).order?(t(),Q(Fr,{key:2,order:r(c).order,onBack:E,onTrack:b[0]||(b[0]=H=>q("حالة طلبك "+r(c).order.ref+": قيد التجهيز"))},null,8,["order"])):O("",!0)])]),e("footer",Br,[e("div",_r,[b[6]||(b[6]=e("div",null,[e("h3",null,"تواصل معنا"),e("form",{class:"phone-form",onsubmit:"return false"},[e("span",null,"+966"),e("input",{type:"tel",placeholder:"رقم الجوال"})]),e("a",{class:"whatsapp",href:"https://wa.me/966566101963"},"تواصل واتساب ◉")],-1)),b[7]||(b[7]=G('<div><h3>عن سامي</h3><a href="/">الرئيسية</a><a href="/booking">خدماتنا</a><a href="/store">المنتجات</a><a href="/packages-gifts">الباقات</a></div><div class="footer-brand"><a href="/"><img src="'+de+'" alt="عناية سامي"></a></div><div><h3>مساعدة</h3><a href="/contact">اتصل معنا</a><a href="#">الشكاوى والاقتراحات</a><a href="#">سياسة الخصوصية</a><a href="#">الشروط والأحكام</a></div>',3)),e("div",null,[b[5]||(b[5]=e("h3",null,"عناوين الفروع",-1)),(t(!0),s($,null,Y(r(F),H=>(t(),s($,{key:H.id},[e("b",null,i(H.name),1),e("p",null,[g(i(H.address),1),H.contact_number?(t(),s($,{key:0},[b[4]||(b[4]=e("br",null,null,-1)),g(i(H.contact_number),1)],64)):O("",!0)])],64))),128))])]),b[8]||(b[8]=e("p",{class:"copyright"},"© 2026 عناية سامي. جميع الحقوق محفوظة.",-1))]),e("div",{class:A(["sheet-ov",{on:w.value}]),id:"sheetOv",onClick:b[1]||(b[1]=H=>w.value=!1)},null,2),e("div",{class:A(["sheet",{on:w.value}]),id:"sheet"},[b[9]||(b[9]=G('<div class="grab"></div><div class="shead"><span class="si"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 7h12l1.5 14h-15zM8 7a4 4 0 018 0"></path><path d="M9.5 13.5l1.8 1.8 3.4-3.4"></path></svg></span><b>تم إضافة المنتج</b></div>',2)),e("div",Mr,[S.value?(t(),s($,{key:0},[e("span",jr,[(t(),s("svg",{class:"prod",width:"46",height:"46",viewBox:W().viewBox,innerHTML:W().inner},null,8,Er))]),e("span",Ar,[e("b",null,i(S.value.n),1),e("span",Lr,i(r(D)(S.value.pr))+" ر.س",1)])],64)):O("",!0)]),e("div",Sr,[e("button",{class:"btn btn-line",id:"sheetCont",onClick:b[2]||(b[2]=H=>w.value=!1)},"متابعة التسوق"),e("button",{class:"btn btn-gold",id:"sheetView",onClick:b[3]||(b[3]=H=>{w.value=!1,_()})},"عرض السلة")])],2),d(pe,{open:y.value,onClose:n,onCheckout:a},null,8,["open"]),e("div",{class:A(["pay-loading",{on:I.value}]),id:"payLoading"},[...b[10]||(b[10]=[e("div",{class:"pl-box"},[e("div",{class:"pl-ring"}),e("b",null,"جارٍ معالجة طلبك بأمان…"),e("small",null,"لا تغلق الصفحة، سيتم تأكيد طلبك خلال لحظات")],-1)])],2),e("div",{class:A(["toast-top",{on:o.value}]),id:"toastTop"},[b[11]||(b[11]=e("span",{class:"ti"},[e("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"3"},[e("path",{d:"M20 6L9 17l-5-5"})])],-1)),e("span",qr,i(j.value),1)],2)],512))}};export{Yr as default};
