            ...
            <div class="col">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6 col-sm-10">
                        {{ html()->checkbox('status', true, '1') }} {{ __('users.active') }}
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6 col-sm-10">
                        {{ html()->checkbox('confirmed', true, '1') }} {{ __('users.email_confirmed') }}
                    </div>
                </div>
                ...
                <div class="form-group row">
                    {{ html()->label(__('users.abilities'))->class('col-sm-2 form-control-label') }}
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <x-buttons.create title="{{ __('users.create') }} {{ __($module_title) }}">
                                {{ __('users.create') }}
                            </x-buttons.create>
                        </div>
                    </div>
