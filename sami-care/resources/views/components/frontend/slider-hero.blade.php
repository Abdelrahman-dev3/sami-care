...
<div class="screen-hero">
    <div class="content">
        ...
        <div class="text-content">
            ...
            <h1>
                {{ __('messagess.your_look') }}
                <span>
                    {{ __('messagess.your_signature') }}
                </span>
            </h1>
            <h1>
                <span>
                    {{ __('messagess.your_elegance') }}
                </span>
                {{ __('messagess.starts_here') }}
            </h1>
            
            <div class="sub-title d-flex">
                <p>
                    {{ __('messagess.modern_cuts') }}
                </p>
                <p class="mt-28">
                    {{ __('messagess.professional_experience') }}
                </p>
                <p>
                    {{ __('messagess.full_care') }}
                </p>
            </div>
            <a href="{{route('salon.create')}}" class="more-btn-main">
                <p style="color:white;font-size: 18px;margin: 0 13px;">
                    <img style="width: 18px;margin: 0 8px;" src="{{ asset('images/icons/Vector (2).png') }}" >
