...
return [
    ...
    'ARRAY_MENU' => [
        ...
        [
            ...
            'nickname' => 'cafe',
            'menu_item_type' => 'parent',
            'permission' => ['view_cafe'],
            'active' => ['app/cafe*'],
            'order' => 8,
            'children' => [
                [
                    'title' => 'cafe.categories',
                    'route' => 'backend.cafe.categories.index',
                    'active' => ['app/cafe/categories*'],
                    'permission' => ['manage_cafe_categories'],
                    'order' => 0,
                    'menu_level' => 1,
                ],
                [
                    'title' => 'cafe.items',
                    'route' => 'backend.cafe.items.index',
                    'active' => ['app/cafe/items*'],
                    'permission' => ['manage_cafe_items'],
                    'order' => 1,
                    'menu_level' => 1,
                ],
                [
                    'title' => 'cafe.tables',
                    'route' => 'backend.cafe.tables.index',
                    'active' => ['app/cafe/tables*'],
                    'permission' => ['manage_cafe_tables'],
                    'order' => 2,
                    'menu_level' => 1,
                ],
                [
                    'title' => 'cafe.orders',
                    'route' => 'backend.cafe.orders.index',
                    'active' => ['app/cafe/orders*'],
                    'permission' => ['view_cafe_orders'],
                    'order' => 3,
                    'menu_level' => 1,
                ],
            ],
        ...
        [
            ...
            'route' => 'backend.center-info.index',
            'active' => ['app/center-info*'],
            'permission' => ['manage_center_info'],
            'order' => 9,
        ],
        [
            'title' => 'sidebar.users',
    ...
    'H_ARRAY_MENU' => [
        ...
        [
            ...
            'menu_item_type' => 'parent',
            'order' => 5,
            'permission' => ['system_settings', 'view_page', 'view_blog', 'view_app_banner', 'view_role_permissions'],
            'children' => [
                [
                    'menu_type' => 'horizontal',
                    'start_icon' => 'fa-solid fa-gear',
