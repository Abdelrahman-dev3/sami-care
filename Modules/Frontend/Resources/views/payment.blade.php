...
@php
    $pageName = request()->has('is_buy_now') ? 'payment' : 'cart';
@endphp
        ...
        <div class="row gx-4 gy-4">
            ...
            <div class="col-lg-8">
                <div class="panel mb-4">
                    <h5> <span class="iconify" data-icon="tdesign:location"></span></i> {{ __('messagess.service_location') }}</h5>
                ...
                <div class="panel">
                    <h5> <span class="iconify" data-icon="fluent:payment-20-regular"></span> {{ __('booking.lbl_payment') }}</h5>
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-row">
                        ...
                        <div>
                            <strong id="tax">
                            @if($pageName == 'cart')
                                {{ getTaxamount($productsAmount)['total_tax_amount'] }}
                            @endif
                            </strong>
                            {{ __('messagess.SR') }}
                        </div>
