                ...
                <div class="card-header border-bottom-0">
                    <div class="row pr-hide">
                        ...
                        <div class="col-auto col-lg-4 mb-4 text-center text-lg-end">
                            ...
                            <!--    Download Invoice-->
                            <!--</a>-->
                            <button class="btn btn-success" id="downloadInvoiceImage">
...
@push('after-scripts')
    ...
    <script>
    document.getElementById('downloadInvoiceImage').addEventListener('click', function() {
        const invoice = document.getElementById('section-1');
        html2canvas(invoice, {
            scale: 2,
            useCORS: true,
            logging: false
            ...
            link.download = 'invoice_{{ $order->orderGroup->order_code }}.png';
            link.click();
        });
    });
    </script>
