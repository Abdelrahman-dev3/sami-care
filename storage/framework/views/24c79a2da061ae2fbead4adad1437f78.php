...
<head>
    ...
    <title>انضم لبرنامج التسويق | <?php echo e(app_name()); ?></title>
        ...
        <div class="sub-container">
            ...
            <div class="content">
                <div class="section">
                    ...
                    <form action="<?php echo e(route('frontend.become.affiliate.submit')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\VIP\Desktop\sami-care\sami-care\Modules/rontend\Resources/views/become-affiliate.blade.php ENDPATH**/ ?>