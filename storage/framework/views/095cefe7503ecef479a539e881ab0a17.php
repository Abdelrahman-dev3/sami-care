...
<section class="no-offers">
    <div class="content">
        <img src="<?php echo e(asset('images/icons/no-offers (2).png')); ?>" alt="لا توجد عروض" class="no-offers-image">
    </div>
</section><?php /**PATH D:\projects\php8\cityart\samiCare\sami-care\resources\views/components/frontend/no-offers.blade.php ENDPATH**/ ?>