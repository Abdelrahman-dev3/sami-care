...
<html dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>" class="<?php echo e(app()->getLocale()); ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('pages-css/gift.css')); ?>">
        <style>
            .top-label{
                color: white;
                background: #CF9233;
                ...
                <div class="content-form">
                    ...
                    <div class="column-mob" style="display: flex;gap: 34px;">
                        <div class="d-flex w-100-mob" style="flex-direction: column;gap: 12px;width: 47%;">
                            <lable><?php echo e(__('messagess.recipient_name')); ?>:</lable>
                            <input id="recipient_name" type="text">
                        </div>
                        <div class="d-flex w-100-mob" style="flex-direction: column;gap: 12px;width: 47%;">
                            <lable><?php echo e(__('messagess.recipient_mobile')); ?> </lable>
                    ...
                    <div>
                        <div class="d-flex" style="flex-direction: column;gap: 12px;width: 100%;">
                            <lable style="margin-top: 15px;"><?php echo e(__('messagess.gift_message_from_sender')); ?></lable>
                            <textarea id="message" style="height: 140px;" maxlength="500" placeholder="<?php echo e(__('messagess.friend_greeting')); ?>"></textarea>
                        </div>
                    </div>
            ...
            <div class="gift-guide-overlay" id="giftGuideOverlay">
                <div class="gift-guide-card" role="dialog" aria-modal="true" aria-labelledby="giftGuideText">
                    ...
                    <p class="gift-guide-text" id="giftGuideText">
                        <?php echo e(__('messages.gift_guide_text')); ?>

                    </p>
                    <div class="gift-guide-actions">
                        <button type="button" class="gift-guide-next" id="giftGuideNext"><?php echo e(__('messagess.next')); ?></button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function validateCurrentStep() {
            switch (currentStep) {
                case 1:
                    const messages = {
                        fillAll: "<?php echo e(__('messages.fill_all_details')); ?>",
                        invalidMobile: "<?php echo e(__('messages.invalid_saudi_mobile')); ?>"
                    };
                ...
                case 2:
                    ...
                    if (!selectedBranch) {
                        createNotify({ title: '', desc: '<?php echo e(__("messagess.please_select_branch")); ?>'})
                        return false;
                    }
                    break;
                case 3:
        ...
        function completeBooking() {
            ...
            .then(data => {
                if (data.status == true) {
                    ...
                    createNotify({
                        title: "<?php echo e(app()->getLocale() === 'ar' ? 'خطأ' : 'error'); ?>",
                        desc: data.message
                    });
                }
            })
...
<?php /**PATH D:\projects\php8\cityart\samiCare\sami-care\resources\views/salon/gift.blade.php ENDPATH**/ ?>