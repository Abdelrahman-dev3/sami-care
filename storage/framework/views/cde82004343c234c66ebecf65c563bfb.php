...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.quick-action','data' => ['url' => ''.e(route('backend.brands.bulk_action')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('backend.brands.bulk_action')).'']); ?>
                        <div class="">
...
<?php endif; ?>
    ...
    <div data-render="app">
        <brand-form-offcanvas default-image="<?php echo e(default_feature_image()); ?>" create-title="<?php echo e(__('messages.new')); ?> <?php echo e(__('product.brand')); ?>"
            edit-title="<?php echo e(__('messages.edit')); ?> <?php echo e(__('product.brand')); ?>" :customefield="<?php echo e(json_encode($customefield)); ?>">
...
<script type="text/javascript" defer>
        const columns = [
            ...
            },
            {
                data: 'DT_RowIndex',
                name: 'DT_RowIndex',
                title: "<?php echo e(__('service.sr_no')); ?>",
                orderable: false,
                searchable: false,
                width: '5%',
            },
            // { data: 'feature_image', name: 'feature_image', title: "<?php echo e(__('category.lbl_image')); ?>", width: '10%', orderable: false,},
            {
                data: 'name',
                name: 'name',
            ...
            },
            {
                ...
                searchable: true,
                width: '20%',
                title: "<?php echo e(__('service.updated_at')); ?>",
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/city2tec/sami-care.sa/Modules/Product/Resources/views/backend/brands/index_datatable.blade.php ENDPATH**/ ?>