...
<div class="container my-5">
  ...
  function showBranchesForMainService(mainServiceId , subServiceId) {
    showLoader()
fetch(`/api/services/service/branch/${subServiceId}`)
    .then(res => res.json())
    .then(response => {

        const branches = response.data; // 👈 دي الفروع بس
...
<?php /**PATH C:\Users\VIP\Desktop\sami-care\sami-care\Modules/rontend\Resources/views/category-details.blade.php ENDPATH**/ ?>