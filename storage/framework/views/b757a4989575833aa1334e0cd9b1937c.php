                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="datatable-filter">
                            <select name="report_type" id="report_type" class="select2 form-control" data-filter="select">
                                <option value="daily"><?php echo e(__('report.lbl_daily')); ?></option>
                                <option value="monthly"><?php echo e(__('report.lbl_monthly')); ?></option>
                                <option value="custom"><?php echo e(__('report.lbl_custom_range')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
...
<script type="text/javascript" defer>
    const range_flatpicker = document.querySelectorAll('.financial-report-date-range')
    ...
    $('#reset').on('click', function(e) {
        $('#date_range').val('');
        $('#report_type').val('daily').trigger('change');
    ...
    const columns = [
        {
            data: 'period',
            name: 'period',
            title: "<?php echo e(__('report.lbl_period')); ?>",
            orderable: false,
            searchable: false,
        },
        {
            data: 'bookings_total',
            name: 'bookings_total',
            title: "<?php echo e(__('report.lbl_bookings_total')); ?>",
            orderable: false,
            searchable: false,
        },
        {
            data: 'orders_total',
            name: 'orders_total',
            title: "<?php echo e(__('report.lbl_orders_total')); ?>",
            orderable: false,
            searchable: false,
        },
        {
            data: 'grand_total',
            name: 'grand_total',
            title: "<?php echo e(__('report.lbl_grand_total')); ?>",
            orderable: false,
            searchable: false,
        },
    ]
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        initDatatable({
            url: "<?php echo e(route('backend.reports.financial-report.index_data')); ?>",
            finalColumns,
            advanceFilter: () => {
                return {
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/city2tec/sami-care.sa/resources/views/backend/reports/financial-report.blade.php ENDPATH**/ ?>