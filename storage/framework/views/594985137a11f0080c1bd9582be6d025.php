                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="datatable-filter">
                            <select name="coupon_id" id="coupon_id" class="select2 form-control" data-filter="select">
                                <option value=""><?php echo e(__('report.lbl_coupon')); ?></option>
...
<script type="text/javascript" defer>
    const range_flatpicker = document.querySelectorAll('.coupon-report-date-range')
    ...
    const columns = [
        ...
        },
        {
            data: 'coupon_code',
            name: 'coupon_code',
            title: "<?php echo e(__('report.lbl_coupon')); ?>",
            orderable: false,
            searchable: false,
        },
        {
            data: 'promotion_name',
            name: 'promotion_name',
            title: "<?php echo e(__('report.lbl_promotion')); ?>",
            orderable: false,
            searchable: false,
        },
        {
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        initDatatable({
            url: "<?php echo e(route('backend.reports.coupon-report.index_data')); ?>",
            finalColumns,
            advanceFilter: () => {
                return {
                    coupon_id: $('[name="coupon_id"]').val(),
                    coupon_date: $('[name="coupon_date"]').val().split(' to '),
                }
            }
        });
    })

    $(document).on('change', '#coupon_date', function() {
        window.renderedDataTable.ajax.reload(null, false)
    })
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/city2tec/sami-care.sa/resources/views/backend/reports/coupon-report.blade.php ENDPATH**/ ?>