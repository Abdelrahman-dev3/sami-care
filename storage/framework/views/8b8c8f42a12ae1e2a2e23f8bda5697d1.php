...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div id="giftAlert" class="alert alert-warning text-center" role="alert" style="display:none;">
            <?php echo e(__('لاتشمل عمليات شراء الهدايا او المنتجات فرديا')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="datatable-filter">
                            <select name="payment_method" id="payment_method" class="select2 form-control" data-filter="select">
                                <option value=""><?php echo e(__('report.lbl_payment_method')); ?></option>
...
<script type="text/javascript" defer>
    const range_flatpicker = document.querySelectorAll('.payment-report-date-range')
    ...
    const columns = [
        ...
        },
        {
            data: 'booking_id',
            name: 'booking_id',
            title: "<?php echo e(__('report.lbl_booking_id')); ?>",
            orderable: false,
            searchable: false,
        },
        {
            data: 'customer_name',
            name: 'customer_name',
            title: "<?php echo e(__('report.lbl_customer')); ?>",
            orderable: false,
        },
        {
            data: 'transaction_id',
            name: 'transaction_id',
            title: "<?php echo e(__('report.lbl_transaction_id')); ?>",
            orderable: false,
            searchable: false,
        },
        {
            data: 'payment_method',
            name: 'payment_method',
            title: "<?php echo e(__('report.lbl_payment_method')); ?>",
            orderable: false,
            searchable: false,
        },
        {
            data: 'payment_status',
            name: 'payment_status',
            title: "<?php echo e(__('report.lbl_status')); ?>",
            orderable: false,
            searchable: false,
        },
        {
        ...
        },
        {
            ...
            title: "<?php echo e(__('report.lbl_discount_amt')); ?>",
            orderable: false,
            searchable: false,
        },
        {
            data: 'total_amount',
            name: 'total_amount',
            title: "<?php echo e(__('report.lbl_total_amount')); ?>",
            orderable: false,
            searchable: false,
        },
    ]
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        initDatatable({
            url: "<?php echo e(route('backend.reports.payment-transactions-report.index_data')); ?>",
            finalColumns,
            advanceFilter: () => {
                return {
                    payment_method: $('[name="payment_method"]').val(),
                    payment_date: $('[name="payment_date"]').val().split(' to '),
                }
            }
        });
    })
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/city2tec/sami-care.sa/resources/views/backend/reports/payment-transactions-report.blade.php ENDPATH**/ ?>