...
<html dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>" class="<?php echo e(app()->getLocale()); ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('pages-css/h-book-page.css')); ?>">
    </head>
        ...
        <div class="content">
                ...
                <div class="location-form">
                    <div class="form-group">
                        <label class="top-label"> 
                            <?php echo e(__('messagess.location_data')); ?> 
                        </label>
                        <div class="location-form">
                            <div class="form-row">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted"><?php echo e(__('messagess.wsb')); ?></small>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="neighborhood">
                                        ...
                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value=" <?php echo e(json_decode($city->name, true)[app()->getLocale() ?? 'en']); ?>"> <?php echo e(json_decode($city->name, true)[app()->getLocale() ?? 'en']); ?></option>
                            ...
                            <div class="form-group">
                                <label><?php echo e(__('messagess.select_location')); ?></label>
                                <button type="button" id="myLocationBtn"><?php echo e(__('messagess.my_location')); ?></button>
                                <input type="text" id="locationInput" placeholder="<?php echo e(__('messagess.location_placeholder')); ?>" readonly>
                            </div>
            ...
            <div id="step2" class="step-content hidden">
                <label class="top-label" style="width: 58%;margin: auto;">
                    ...
                    <span class="step-help-btn" data-step="step2" data-help='<?php echo json_encode(trans("steps.step2"), 15, 512) ?>'>
            ...
            <div id="step3" class="step-content hidden">
                <label class="top-label" style="width: 58%;margin: auto;"> 
                    ...
                    <span class="step-help-btn" data-step="step3" data-help='<?php echo json_encode(trans("steps.step3"), 15, 512) ?>'>
                        <i class="bi bi-question-circle"></i>
                    </span>
                </label>
                <br>
            ...
            <div id="step4" class="step-content hidden">
                <label class="top-label" style="width: 58%;margin: auto;">
                    ...
                    <span class="step-help-btn" data-step="step4" data-help='<?php echo json_encode(trans("steps.step4"), 15, 512) ?>'>
                        <i class="bi bi-question-circle"></i>
                    </span>    
                </label>
            ...
            switch (currentStep) {
                case 1:
                    ...
                    if (!customerName || !mobileNo || !neighborhood || !locationInput) {
                        alert('<?php echo e(__("messagess.please_fill_data")); ?>');
                        return false;
                    }
...
</html><?php /**PATH /home/city2tec/sami-care.sa/resources/views/home/create.blade.php ENDPATH**/ ?>