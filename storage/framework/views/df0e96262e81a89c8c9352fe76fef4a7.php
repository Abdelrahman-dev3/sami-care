...
<body class="<?php echo e(auth()->user()->user_setting['theme_scheme'] ?? ''); ?>">
    <div class="WheelOfFortune">
        <div class="Wheel">
            ...
            <h1 class="hid-wheel"><?php echo e(__('messagess.get_your_gift')); ?></h1>
            <h5 id="final-value"></h5>
            <h5 class="hid-wheel" style="color: white;"><?php echo e(__('messagess.spin_the_wheel_to_get_your_gift')); ?></h5>
            <input class="hid-wheel" id="name" type="text" placeholder="<?php echo e(__('messagess.name')); ?>:">
            <input class="hid-wheel" id="phone" type="number" placeholder="<?php echo e(__('messagess.phone')); ?>:">
...
<?php endif; ?>
    ...
    <script>
        function showLoginAlert() {
            createNotify({
                title: "<?php echo e(__('messages.alert')); ?>",
                desc: "<?php echo e(__('messages.login_required')); ?>"
            });
        }
</script>
    ...
    <script>
        ...
        const wheelCongrats = <?php echo json_encode(__('messagess.wheel_congrats'), 15, 512) ?>;
        const wheelNotWinner = <?php echo json_encode(__('messagess.wheel_not_winner'), 15, 512) ?>;
        const wheelUnavailable = <?php echo json_encode(__('messagess.wheel_not_available_now'), 15, 512) ?>;
        const wheelSpinError = <?php echo json_encode(__('messagess.wheel_spin_error'), 15, 512) ?>;
        const shouldShowWheel = <?php echo json_encode($shouldShowWheel ?? false, 15, 512) ?>;
        const prizes = <?php echo json_encode($prizes ?? [], 15, 512) ?>;
        const spinUrl = <?php echo json_encode(route('wheel.spin'), 15, 512) ?>;
...
<?php /**PATH D:\projects\php8\cityart\samiCare\sami-care\Modules/rontend\Resources/views/layouts/master.blade.php ENDPATH**/ ?>