<div class="d-flex gap-2 align-items-center">
    ...
    <?php if(Auth::user()->can('view_loyalty')): ?>
        <a href="<?php echo e(route('backend.customers.loyalty_history', $data->id)); ?>" class="btn btn-soft-success btn-sm"
            data-bs-toggle="tooltip" title="<?php echo e(__('messages.loyalty_points')); ?>">
...
<?php /**PATH /home/city2tec/sami-care.sa/Modules/Customer/Resources/views/backend/customers/action_column.blade.php ENDPATH**/ ?>